...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            ...
            status: "unloaded",
            basePath: function () {
                var b = window.CKEDITOR_BASEPATH || "/assets/ckeditor/";
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > f.getListenerIndex(d)) {
                    ...
                    m.fn = d;
                    m.priority = l;
                    for (var t = f.length - 1; 0 <= t; t--)if (f[t].priority <= l)return f.splice(t + 1, 0, m), {removeListener: r};
                    f.unshift(m)
                }
            ...
            once: function () {
                ...
                return function (l, m, r) {
                    ...
                    if (f) {
                        var t = f.listeners;
                        if (t.length)for (var t = t.slice(0), z, x = 0; x < t.length; x++) {
                            if (f.errorProof)try {
                                z =
                                    t[x].call(this, r, m, b, h)
                            } catch (p) {
                            } else z = t[x].call(this, r, m, b, h);
                            !1 === z ? g = 1 : "undefined" != typeof z && (m = z);
                            if (a || g)break
                        }
                    }
                    m = g ? !1 : "undefined" == typeof m ? !0 : m;
                    a = l;
                    g = D;
                    return m
                }
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, e = /</g, g = /"/g, h = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, l = {
                lt: "\x3c",
                gt: "\x3e",
                amp: "\x26",
                quot: '"',
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var p = "\x3c" + l + "\x3e", m = "\x3c/" + l + "\x3e",
            ...
            normalizeCssText: function (a, f) {
                var b = [], c, l = CKEDITOR.tools.parseCssText(a, !0, f);
            ...
            parseCssText: function (a, b, c) {
                ...
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                    function (a, c, p) {
                        b && (c = c.toLowerCase(), "font-family" == c && (p = p.replace(/\s*,\s*/g, ",")), p = CKEDITOR.tools.trim(p));
                        l[c] = p
                    });
                return l
            },
            ...
            keystrokeToString: function (a, b) {
                var c = b & 16711680, l =
                    b & 65535, d = CKEDITOR.env.mac, m = [], p = [];
                c & CKEDITOR.CTRL && (m.push(d ? "⌘" : a[17]), p.push(d ? a[224] : a[17]));
                c & CKEDITOR.ALT && (m.push(d ? "⌥" : a[18]), p.push(a[18]));
                c & CKEDITOR.SHIFT && (m.push(d ? "⇧" : a[16]), p.push(a[16]));
                l && (a[l] ? (m.push(a[l]), p.push(a[l])) : (m.push(String.fromCharCode(l)), p.push(String.fromCharCode(l))));
                return {display: m.join("+"), aria: p.join("+")}
            },
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, l = {"#": 1}, m = {
            center: 1,
            dir: 1,
            noframes: 1
        };
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++)if (f)for (var t =
                        0; t < f.length; t++)b.push([a, c[d], f[t]].join("-")); else b.push([a, c[d]].join("-"));
                ...
                var b = 0, c = 0, f = this.getDocument(), d = f.getBody(), t = "BackCompat" == f.$.compatMode;
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var e = this.$.getBoundingClientRect(), g = f.$.documentElement,
                        p = g.clientTop || d.$.clientTop || 0, w = g.clientLeft || d.$.clientLeft || 0, h = !0;
                    CKEDITOR.env.ie && (h = f.getDocumentElement().contains(this), f = f.getBody().contains(this), h = t && f || !t && h);
                    h && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = t ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = e.left + b - w, c = e.top + c - p)
                } else for (p = this, w = null; p && "body" != p.getName() &&
                "html" != p.getName();) {
                    b += p.$.offsetLeft - p.$.scrollLeft;
                    c += p.$.offsetTop - p.$.scrollTop;
                    p.equals(this) || (b += p.$.clientLeft || 0, c += p.$.clientTop || 0);
                    for (; w && !w.equals(p);)b -= w.$.scrollLeft, c -= w.$.scrollTop, w = w.getParent();
                    w = p;
                    p = (e = p.$.offsetParent) ? new CKEDITOR.dom.element(e) : null
                }
                a && (e = this.getWindow(), p = a.getWindow(), !e.equals(p) && e.$.frameElement && (a = (new CKEDITOR.dom.element(e.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
                ...
                e = a.getWindow();
                d = p(this, e);
                var v = p(a, e), u = this.$.offsetHeight;
                f = this.$.offsetWidth;
                var k = a.$.clientHeight, q = a.$.clientWidth;
                e = d.x - w(this, "left") - v.x || 0;
                z = d.y - w(this, "top") - v.y || 0;
                f = d.x + f + w(this, "right") - (v.x + q) || 0;
                d = d.y + u + w(this, "bottom") - (v.y + k) || 0;
            ...
            getFrameDocument: function () {
                ...
                for (var f = 0; f < c.length; f++) {
                    var d = c[f], e = d.nodeName.toLowerCase(), g;
                    if (!(e in b))if ("checked" == e && (g = this.getAttribute(e))) a.setAttribute(e, g); else if (!CKEDITOR.env.ie || this.hasAttribute(e)) g = this.getAttribute(e), null === g && (g = d.nodeValue), a.setAttribute(e, g)
                }
                "" !== this.$.style.cssText &&
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, D = c.endOffset, u, k = this.guard, q = this.type,
                n = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var y = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(),
                    g = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(D) : f.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !y.equals(a)) && (!g || !a.equals(g)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function (a, b) {
                    return (!b || !h.equals(a)) && (!G || !a.equals(G)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            var l = a ? this._.guardRTL : this._.guardLTR;
            u = k ? function (a, b) {
                return !1 === l(a, b) ? !1 : k(a, b)
            } : l;
            this.current ? f = this.current[n](!1, q, u) : (a ? f.type == CKEDITOR.NODE_ELEMENT &&
                (f = 0 < D ? f.getChild(D - 1) : !1 === u(f, !0) ? null : f.getPreviousSourceNode(!0, q, u)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === u(d, !0) ? null : d.getNextSourceNode(!0, q, u)))), f && !1 === u(f) && (f = null));
            for (; f && !this._.end;) {
                this.current = f;
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(),
            h = CKEDITOR.dom.walker.bookmark(), l = CKEDITOR.dom.walker.temp(), m = function (a) {
        ...
        CKEDITOR.dom.walker.editable = function (a) {
            return function (b) {
                b =
                    r(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(D) && f(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            function p(a, b, c, f) {
                ...
                if (f && l)return d;
                k || f ? b.append(a.clone(!0, e), c) : (a.remove(), u && b.append(a));
                return d
            }

            function g() {
                var a, b, c, f = Math.min(O.length, B.length);
                for (a = 0; a < f; a++)if (b = O[a], c = B[a], !b.equals(c))return a;
                return a - 1
            }

            function h() {
                var b = I - 1, c = C && r && !q.equals(n);
                b < E - 1 || b < K - 1 || c ? (c ? a.moveToPosition(n,
            ...
            a.optimizeBookmark();
            var l = 0 === b, u = 1 == b, k = 2 == b;
            b = k || u;
            var q = a.startContainer, n = a.endContainer,
                y = a.startOffset, A = a.endOffset, J, G, C, r, m, P;
            if (k && n.type == CKEDITOR.NODE_TEXT && q.equals(n)) q = a.document.createText(q.substring(y, A)), c.append(q); else {
                n.type == CKEDITOR.NODE_TEXT ? k ? P = !0 : n = n.split(A) : 0 < n.getChildCount() ? A >= n.getChildCount() ? (n = n.getChild(A - 1), G = !0) : n = n.getChild(A) : r = G = !0;
                q.type == CKEDITOR.NODE_TEXT ? k ? m = !0 : q.split(y) : 0 < q.getChildCount() ? 0 === y ? (q = q.getChild(y), J = !0) : q = q.getChild(y - 1) : C = J = !0;
                for (var O = q.getParents(), B = n.getParents(), I = g(), E = O.length - 1, K = B.length - 1, F = c, L, aa, V, ga = -1, R = I; R <= E; R++) {
                    aa =
                        O[R];
                    V = aa.getNext();
                    for (R != E || aa.equals(B[R]) && E < K ? b && (L = F.append(aa.clone(0, e))) : J ? p(aa, F, !1, C) : m && F.append(a.document.createText(aa.substring(y))); V;) {
                        if (V.equals(B[R])) {
                            ga = R;
                            break
                        }
                ...
                F = c;
                for (R = I; R <= K; R++)if (c = B[R], V = c.getPrevious(), c.equals(O[R])) b && (F = F.getChild(0)); else {
                    R != K || c.equals(O[R]) && K < E ? b && (L = F.append(c.clone(0, e))) : G ? p(c, F, !1, r) : P && F.append(a.document.createText(c.substring(0, A)));
                    if (R > ga)for (; V;)V = p(V, F, !0);
                    F = L
                }
                k || h()
            }
        ...
        var g = {
                ...
                u: 1,
                "var": 1
            }, h = CKEDITOR.dom.walker.bogus(), l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, m = CKEDITOR.dom.walker.editable(),
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var p = function (a, b) {
                            ...
                            for (c.guard = function (a) {
                                ...
                                J = f != a ? f.getText() : f.substring(b);
                                if (d.test(J))return !1
                            }
                            return !0
                        };
                        if (this.collapsed)break;
                        var g = this.getCommonAncestor(), h = this.root, l, u, k, q, n, y = !1, A, J;
                        A = this.startContainer;
                        var G = this.startOffset;
                        A.type == CKEDITOR.NODE_TEXT ? (G && (A = !CKEDITOR.tools.trim(A.substring(0, G)).length && A, y = !!A), A && ((q = A.getPrevious()) || (k = A.getParent()))) : (G && (q = A.getChild(G - 1) || A.getLast()), q || (k = A));
                        for (k = c(k); k || q;) {
                            if (k && !q) {
                                !n && k.equals(g) && (n = !0);
                                if (e ? k.isBlockBoundary() :
                                        !h.contains(k))break;
                                y && "inline" == k.getComputedStyle("display") || (y = !1, n ? l = k : this.setStartBefore(k));
                                q = k.getPrevious()
                            }
                            for (; q;)if (A = !1, q.type == CKEDITOR.NODE_COMMENT) q = q.getPrevious(); else {
                                if (q.type == CKEDITOR.NODE_TEXT) J = q.getText(), d.test(J) && (q = null), A = /[\s\ufeff]$/.test(J); else if ((q.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && q.is("br")) && !q.data("cke-bookmark"))if (y && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                    J = q.getText();
                                    if (d.test(J)) q = null; else for (var G = q.$.getElementsByTagName("*"), C = 0, r; r =
                                        G[C++];)if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) {
                                        q = null;
                                        break
                                    }
                                    q && (A = !!J.length)
                                } else q = null;
                                A && (y ? n ? l = k : k && this.setStartBefore(k) : y = !0);
                                if (q) {
                                    A = q.getPrevious();
                                    if (!k && !A) {
                                        k = q;
                        ...
                        k = q = null;
                        n = y = !1;
                        A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(G)).length ? y = !0 : (y = !A.getLength(), G == A.getLength() ? (q = A.getNext()) || (k = A.getParent()) : p(A, G) && (k = A.getParent())) : (q = A.getChild(G)) || (k = A);
                        for (; k ||
                               q;) {
                            if (k && !q) {
                                !n && k.equals(g) && (n = !0);
                                if (e ? k.isBlockBoundary() : !h.contains(k))break;
                                y && "inline" == k.getComputedStyle("display") || (y = !1, n ? u = k : k && this.setEndAfter(k));
                                q = k.getNext()
                            }
                            for (; q;) {
                                A = !1;
                                if (q.type == CKEDITOR.NODE_TEXT) J = q.getText(), p(q, 0) || (q = null), A = /^[\s\ufeff]/.test(J); else if (q.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < q.$.offsetWidth || b && q.is("br")) && !q.data("cke-bookmark"))if (y && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                        J = q.getText();
                                        if (d.test(J)) q = null; else for (G = q.$.getElementsByTagName("*"), C =
                                            0; r = G[C++];)if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) {
                                            q = null;
                                            break
                                        }
                                        q && (A = !!J.length)
                        ...
                        l && u && (g = l.contains(u) ? u : l, this.setStartBefore(g), this.setEndAfter(g));
                        break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        k.setEnd(this.startContainer,
                            this.startOffset);
                        k = new CKEDITOR.dom.walker(k);
                        var m, P,
                            O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                            B = null, I = function (a) {
                                if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))if (B) {
                                    if (B.equals(a)) {
                                        B = null;
                                        return
                                    }
                                } else B = a; else if (B)return;
                                var b = O(a);
                                b || (m = a);
                                return b
                            }, e = function (a) {
                        ...
                        k = k.lastBackward();
                        m = m || h;
                        this.setStartAt(m, !m.is("br") && (!k && this.checkStartOfBlock() || k && m.contains(k)) ?
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, p = this.endContainer, g = this.startOffset,
                        h = this.endOffset, l = 1, u = 1;
                    e && e.type == CKEDITOR.NODE_TEXT && (g ? g >= e.getLength() ? d.setStartAfter(e) : (d.setStartBefore(e), l = 0) : d.setStartBefore(e));
                    p && p.type == CKEDITOR.NODE_TEXT && (h ? h >= p.getLength() ? d.setEndAfter(p) :
                        (d.setEndAfter(p), u = 0) : d.setEndBefore(p));
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, p = d.block, g = null;
                ...
                return {previousBlock: e, nextBlock: p, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: g}
                ...
                for (var c = 0; a;) {
                    ...
                    if (a.type == CKEDITOR.NODE_ELEMENT)if (a.isEditable()) this.moveToPosition(a, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_START), c = 1; else if (b && a.is("br") && this.endContainer && this.checkEndOfBlock()) this.moveToPosition(a, CKEDITOR.POSITION_BEFORE_START); else if ("false" == a.getAttribute("contenteditable") && a.is(CKEDITOR.dtd.$block))return this.setStartBefore(a), this.setEndAfter(a),
                        !0;
                    var d = a, e = c, p = void 0;
                    d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (p = d[b ? "getLast" : "getFirst"](r));
                    e || p || (p = d[b ? "getPrevious" : "getNext"](r));
                    a = p
                }
                return !!c
            }, moveToClosestEditablePosition: function (a, b) {
                var c, d = 0, e, p, g = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
                a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, g[b ? 0 : 1])) : c = this.clone();
                if (a && !a.is(CKEDITOR.dtd.$block)) d = 1; else if (e = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]()) d = 1, (p = e.type == CKEDITOR.NODE_ELEMENT) &&
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], p, g, h, l;
                if (c && c.find)for (g = c.find(a), p = 0; p < g.count(); p++)if (c = g.getItem(p), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED,
                h && l && e.push(c);
                return e
            }
        }
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    h = p.startPath();
                    var w = p.endPath(), H = !p.collapsed && c(p, h.block), v = !p.collapsed && c(p, w.block, 1);
                    p.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    H && p.setStartAt(h.block, CKEDITOR.POSITION_BEFORE_END);
                    v && p.setEndAt(w.block, CKEDITOR.POSITION_AFTER_START);
                    h = p.endContainer.hasAscendant("pre", !0) || p.startContainer.hasAscendant("pre", !0);
                    ...
                    (w = new CKEDITOR.dom.elementPath(w.endContainer, w.root), this._.lastNode = (w.block || w.blockLimit).getNextSourceNode(!0))), this._.lastNode && p.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = p.document.createText(""), this._.lastNode.insertAfter(h)), p = null);
                    this._.started = 1;
                    h = p
                }
                w = this._.nextNode;
                ...
                for (this._.nextNode = null; w;) {
                    var H = 0, v = w.hasAscendant("pre"), u = w.type != CKEDITOR.NODE_ELEMENT, k = 0;
                    if (u) w.type == CKEDITOR.NODE_TEXT && e.test(w.getText()) && (u = 0); else {
                        var q = w.getName();
                        if (CKEDITOR.dtd.$block[q] && "false" == w.getAttribute("contenteditable")) {
                            d = w;
                            b(this, a, d);
                            break
                        } else if (w.isBlockBoundary(this.forceBrBreak && !v && {br: 1})) {
                            if ("br" == q) u = 1; else if (!h && !w.getChildCount() && "hr" != q) {
                                d = w;
                                t = w.equals(p);
                                break
                            }
                            h && (h.setEndAt(w, CKEDITOR.POSITION_BEFORE_START), "br" != q && (this._.nextNode = w));
                            H = 1
                        } else {
                            if (w.getFirst()) {
                                h || (h = this.range.clone(), h.setStartAt(w, CKEDITOR.POSITION_BEFORE_START));
                                w = w.getFirst();
                                continue
                            }
                            u = 1
                    ...
                    u && !h && (h = this.range.clone(), h.setStartAt(w, CKEDITOR.POSITION_BEFORE_START));
                    t = (!H || u) && w.equals(p);
                    if (h && !H)for (; !w.getNext(l) && !t;) {
                        q = w.getParent();
                        if (q.isBlockBoundary(this.forceBrBreak && !v && {br: 1})) {
                            H = 1;
                            u = 0;
                            t || q.equals(p);
                    ...
                    u && h.setEndAt(w, CKEDITOR.POSITION_AFTER_END);
                    w = this._getNextSourceNode(w, k, p);
                    if ((t = !w) || H && h)break
                }
                if (!d) {
                ...
                x && (z = d.getLast()) && z.type == CKEDITOR.NODE_ELEMENT && "br" == z.getName() && (!CKEDITOR.env.needsBrFiller || z.getPrevious(g) || z.getNext(g)) && z.remove();
                this._.nextNode || (this._.nextNode = t || d.equals(p) || !p ? null : this._getNextSourceNode(d, 1, p));
                return d
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (k in b) {
                q = b[k];
                q = "boolean" == typeof q ? {} : "function" == typeof q ? {match: q} : C(q);
                "$" != k.charAt(0) && (q.elements = k);
                ...
                for (p in P) {
                    n[p] = h(n[p], f) || null;
                    var E = n, g = O[p], u = h(n[O[p]], f), y = n[p], B = [], A = !0, K = void 0;
                    u ? A = !1 : u = {};
                    for (K in y)"!" == K.charAt(0) && (K = K.slice(1), B.push(K), u[K] = !0, A = !1);
                    for (; K = B.pop();)y[K] =
                        y["!" + K], delete y["!" + K];
                    E[g] = (A ? !1 : u) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                k = C(a[c]);
                q = !0 === k.classes || !0 === k.styles || !0 === k.attributes;
                n = k;
                p = g = f = void 0;
                for (f in P)n[f] = H(n[f]);
                E = !0;
                for (p in O) {
                    f = O[p];
                    g = n[f];
                    u = [];
                    y = void 0;
                    for (y in g)-1 < y.indexOf("*") ? u.push(new RegExp("^" + y.replace(/\*/g, ".*") + "$")) : u.push(y);
                    g = u;
                    g.length && (n[f] = g, E = !1)
                }
                n.nothingRequired = E;
                ...
                if (!0 === k.elements ||
                    null === k.elements) e[q ? "unshift" : "push"](k); else for (G in n = k.elements, delete k.elements, n)if (b[G]) b[G][q ? "unshift" : "push"](k); else b[G] = [k]
            }
        }

        function d(a, c, d, e) {
            if (!a.match || a.match(c))if (e || l(a, c))if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
                a = a.classes;
                c = c.classes;
                e = d.validClasses;
                if (a)if (!0 === a) a = !0; else {
                    for (var k = 0, q = c.length, n; k < q; ++k)n = c[k], e[n] ||
                    (e[n] = a(n));
                    a = !1
                } else a = !1;
                d.allClasses = a
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, k = !0 === a, q = b.length; q--;)if (k || a(b[q])) b.splice(q, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        function l(a, b) {
            ...
            var c, d, e, k;
            if (e = a.requiredClasses)for (k = b.classes, c = 0; c < e.length; ++c)if (d = e[c], "string" == typeof d) {
                if (-1 == CKEDITOR.tools.indexOf(k, d))return !1
            } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(k, d))return !1;
        ...
        function f(a) {
            var b, c, d, e, k = {}, q = 1;
            for (a = Z(a); b = a.match(B);)(c = b[2]) ? (d = D(c, "styles"), e = D(c, "attrs"), c = D(c, "classes")) : d = e = c = null, k["$" + q++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: e
        ...
        function z(a, b, e, k) {
            var n = 0, f;
            k.toHtml && (b.name = b.name.replace(E, "$1"));
            if (k.doCallbacks && a.elementCallbacks) {
                a:{
                    f = a.elementCallbacks;
                    for (var g = 0, u = f.length, y; g < u; ++g)if (y = f[g](b)) {
                        f = y;
                        break a
                    }
                    f = void 0
            ...
            if (k.doTransform && (f = a._.transformations[b.name])) {
                t(b);
                for (g = 0; g < f.length; ++g)q(a, b, f[g]);
                p(b)
            }
            if (k.doFilter) {
                a:{
                    g = b.name;
                    u = a._;
                    a = u.allowedRules.elements[g];
                    f = u.allowedRules.generic;
                    g = u.disallowedRules.elements[g];
                    ...
                    if (a || f) {
                        t(b);
                        if (g)for (B = 0, A = g.length; B < A; ++B)if (!1 === c(g[B], b, h)) {
                            a = null;
                            break a
                        }
                        if (u)for (B = 0, A = u.length; B < A; ++B)c(u[B], b, h);
                        if (a)for (B = 0, A = a.length; B < A; ++B)d(a[B], b, h, y);
                        if (f)for (B = 0, A = f.length; B < A; ++B)d(f[B], b, h, y);
                        a = h
                    } else a = null
                }
                ...
                var G = a.validStyles;
                f = a.validClasses;
                var g = b.attributes, l = b.styles, u = b.classes;
                y = b.classBackup;
                var J = b.styleBackup, F, I, C = [], h = [], m = /^data-cke-/;
                B = !1;
                delete g.style;
                delete g["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes)for (F in g)A[F] || (m.test(F) ? F == (I = F.replace(/^data-cke-saved-/, "")) || A[I] || (delete g[F], B = !0) : (delete g[F], B = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (F in l)a.allStyles || G[F] ? C.push(F + ":" + l[F]) : B = !0;
                    C.length && (g.style = C.sort().join("; "))
                } else J && (g.style = J);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (F = 0; F < u.length; ++F)(a.allClasses || f[u[F]]) && h.push(u[F]);
                    h.length && (g["class"] = h.sort().join(" "));
                    y && h.length < y.split(/\s+/).length && (B = !0)
                } else y && (g["class"] = y);
                B && (n = 1);
                if (!k.skipFinalValidation && !w(b))return e.push(b), 1
            }
            k.toHtml && (b.name = b.name.replace(K, "cke:$1"));
            return n
        }
        ...
        function u(a) {
            return a.type == CKEDITOR.NODE_ELEMENT && ("br" ==
                a.name || G.$block[a.name])
        }

        function k(a, b, c) {
            var d = a.name;
            if (G.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (G.$block[d] || "tr" == d)if ("br" == b) a.previous && !u(a.previous) && (b = v(), b.insertBefore(a)), a.next && !u(a.next) && (b = v(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e;
                b:{
                    e = G[b];
                    for (var k = 0, q = d.length, n; k < q; ++k)if (n = d[k], n.type == CKEDITOR.NODE_ELEMENT && !e[n.name]) {
                        e = !1;
                        break b
                    }
                    e = !0
                ...
                if (e) a.name = b, a.attributes =
                    ...
                    e = a.parent;
                    for (var k = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, f, g, q = d.length; 0 < q;)n = d[--q], k && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && G.$inline[n.name]) ? (f || (f = new CKEDITOR.htmlParser.element(b), f.insertAfter(a), c.push({
                        check: "parent-down",
                        el: f
                    })), f.add(n, 0)) : (f = null, g = G[e.name] || G.span, n.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || g[n.name] || c.push({
                        check: "el-up",
                        el: n
                    }));
                    a.remove()
        ...
        function n(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, k, q, n, f;
            if (a.name != c.element)return !1;
            for (k in d)if ("class" == k)for (c = d[k].split(/\s+/), n = a.classes.join("|"); f = c.pop();) {
                if (-1 == n.indexOf(f))return !1
            } else if (a.attributes[k] != d[k])return !1;
            for (q in e)if (a.styles[q] !=
                e[q])return !1;
            return !0
        }
        ...
        var G = CKEDITOR.dtd, C = CKEDITOR.tools.copy, Z = CKEDITOR.tools.trim, Q = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter = function (a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                !0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(Q[a.enterMode] + " " + Q[a.shiftEnterMode], "default",
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                if ("string" == typeof b) b = f(b); else if (b instanceof CKEDITOR.style) {
                    ...
                    d && (d =
                        C(d), e.classes = d["class"] ? d["class"].split(/\s+/) : null, e.requiredClasses = e.classes, delete d["class"], e.attributes = d, e.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
                } else if (CKEDITOR.tools.isArray(b)) {
                    for (e = 0; e < b.length; ++e)k = this.allow(b[e], c, d);
                    return k
                }
                ...
                var e = this, q = [], n = this.editor && this.editor.config.protectedSource, f, g = !1, p = {
                    doFilter: !c,
                    doTransform: !0,
                    doCallbacks: !0,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))if (f = z(e, a, q, p), f & 1) g = !0; else if (f & 2)return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var k, u, E;
                            if (n)for (u = 0; u < n.length; ++u)if ((E = d.match(n[u])) && E[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (k = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, k, c, p);
                            c = !c.length
                        }
                        c || q.push(a)
                    }
                ...
                var u;
                a = [];
                d = Q[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)];
                for (var E; c = q.pop();)c.type == CKEDITOR.NODE_ELEMENT ? k(c, d, a) : c.remove();
                for (; u = a.pop();)if (c = u.el, c.parent)switch (E = G[c.parent.name] || G.span, u.check) {
                    case "it":
                        G.$removeEmpty[c.name] && !c.children.length ? k(c, d, a) : w(c) || k(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type ==
                        CKEDITOR.NODE_DOCUMENT_FRAGMENT || E[c.name] || k(c, d, a);
                        break;
                    case "parent-down":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || E[c.name] || k(c.parent, d, a)
                }
                return g
            ...
            addContentForms: function (a) {
                if (!this.disabled && a) {
                    ...
                    if (e) {
                        for (b = 0; b < a.length; ++b)d.push(y(a[b], e));
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var k = void 0, q = void 0, n = void 0, f = void 0, g = void 0, p = void 0;
                        c = [];
                        for (q = 0; q < b.length; ++q)n = b[q], "string" == typeof n ? (n = n.split(/\s*:\s*/), f = n[0], g = null, p = n[1]) : (f = n.check, g = n.left, p = n.right), k || (k = n, k = k.element ? k.element : f ? f.match(/^([a-z0-9]+)/i)[0] :
                            k.left.getDefinition().element), g instanceof CKEDITOR.style && (g = A(g)), c.push({
                            check: f == k ? null : f,
                            left: g,
                            right: "string" == typeof p ? J(p) : p
                        });
                        b = k;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                ...
                if ("string" == typeof a) {
                    ...
                    e = d
                } else d = a.getDefinition(), e = d.styles, n = d.attributes || {}, e && !CKEDITOR.tools.isEmpty(e) ? (e = C(e), n.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {}, e = {
                    name: d.element,
                    attributes: n,
                ...
                var n = CKEDITOR.tools.clone(e), g = [], u;
                if (!1 !== b && (u = this._.transformations[e.name])) {
                    for (d =
                             0; d < u.length; ++d)q(this, e, u[d]);
                    p(e)
                }
                z(this, n, g, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
                b = 0 < g.length ? !1 : CKEDITOR.tools.objectCompare(e.attributes, n.attributes, !0) ? !0 : !1;
                ...
                return function (c, d) {
                    var e = a.slice(), k;
                    if (this.check(Q[c]))return c;
                    for (d || (e = e.reverse()); k = e.pop();)if (this.check(k))return b[k];
        ...
        var P = {styles: 1, attributes: 1, classes: 1}, O = {
        ...
        F = CKEDITOR.filter.transformationsTools = {
            ...
            }, matchesStyle: n, transform: function (a, b) {
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, k, n, q, f;
                    a.name = c.element;
                    for (k in e)if ("class" ==
                        k)for (c = a.classes.join("|"), q = e[k].split(/\s+/); f = q.pop();)-1 == c.indexOf(f) && a.classes.push(f); else a.attributes[k] = e[k];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, e, g) {
                ...
                h && (b = [b]);
                e || (e = CKEDITOR);
                var l = b.length, m = [], r = [], f = function (a) {
                    c && (h ? c.call(e, a) : c.call(e, m, r))
                };
                if (0 === l) f(!0); else {
                    var D = function (a, b) {
                        (b ? m : r).push(a);
                        ...
                        if (a[b]) D(b, !0); else {
                            ...
                            if (!(1 < e.length)) {
                                ...
                                c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? f.$.onreadystatechange = function () {
                                    if ("loaded" == f.$.readyState || "complete" == f.$.readyState) f.$.onreadystatechange = null, t(b, !0)
                                } : (f.$.onload = function () {
                                    setTimeout(function () {
                                        t(b, !0)
                                    }, 0)
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            for (var c = this.loaded, e = this.registered, g = [], h = {}, l = {}, m = 0; m < a.length; m++) {
                var r = a[m];
                if (r)if (c[r] || e[r]) l[r] = this.get(r); else {
            ...
            CKEDITOR.scriptLoader.load(g, function (a, e) {
                ...
                for (var f = 0; f < a.length; f++)for (var g = h[a[f]], p = 0; p < g.length; p++) {
                    var w = g[p];
                    l[w] = this.get(w);
                    c[w] = 1
                }
        ...
        return function (b, c, e) {
            var g = {}, h = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], f;
                    for (f in a) {
                        var l = a[f], t = l && l.requires;
                        if (!d[f]) {
                            if (l.icons)for (var z = l.icons.split(","), x = z.length; x--;)CKEDITOR.skin.addIcon(z[x], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + z[x] + ".png");
                            d[f] = 1
                        }
                        if (t)for (t.split && (t = t.split(",")), l = 0; l < t.length; l++)g[t[l]] || b.push(t[l])
                    }
    ...
    (function () {
        ...
        function d() {
            do var a = "editor" + ++z; while (CKEDITOR.instances[a]);
            return a
        }
        ...
        function D(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var f in c) {
                    var g = c[f], u = g.lang, h = null, l = g.requires, m;
                    CKEDITOR.tools.isArray(l) && (l = l.join(","));
                    if (l && (m = l.match(q)))for (; l = m.pop();)CKEDITOR.error("editor-plugin-required",
                        {plugin: l.replace(",", ""), requiredBy: f});
                    u && !a.lang[f] && (u.split && (u = u.split(",")), 0 <= CKEDITOR.tools.indexOf(u, a.langCode) ? h = a.langCode : (h = a.langCode.replace(/-.*/, ""), h = h != a.langCode && 0 <= CKEDITOR.tools.indexOf(u, h) ? h : 0 <= CKEDITOR.tools.indexOf(u, "en") ? "en" : u[0]), g.langEntries && g.langEntries[h] ? (a.lang[f] = g.langEntries[h], h = null) : k.push(CKEDITOR.getUrl(g.path + "lang/" + h + ".js")));
                    e.push(h);
                    d.push(g)
                }
                CKEDITOR.scriptLoader.load(k, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], k = 0; k < c.length; k++)for (var n =
                        0; n < d.length; n++) {
                        var q = d[n];
                        0 === k && e[n] && q.lang && q.langEntries && (a.lang[q.name] = q.langEntries[e[n]]);
                        if (q[c[k]]) q[c[k]](a)
                    }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, e, k, q, n = 0; n < c.length; n++) {
                    var f = c[n], g = f.startContainer;
                    g.getName && "tr" == g.getName() ? (e || (e = g.getAscendant("table").clone(), e.append(g.getAscendant("tbody").clone()), d.append(e), e = e.findOne("tbody")), k && k.equals(g) || (k = g, q = g.clone(), e.append(q)), q.append(f.cloneContents())) : d.append(f.cloneContents())
                }
                ...
                var b = a.name, c = this.keystrokeHandler.keystrokes, d;
                    ...
                    if (h) h.push(c[0]); else if (e = c[3]) {
                        if (e = e.toLowerCase(), !/="/.test(e)) {
                            ...
                            if (r)for (; m = a.exec(r);) {
                                ...
                                m = m[2] || m[3] || m[4] || "";
                                l[f] = !m && d[f] ? f : CKEDITOR.tools.htmlDecodeAttr(m)
                            }
            ...
            function (g, h, l) {
                function m(a) {
                    ...
                    if (0 < w.length)for (var c = 0; c < w.length; c++) {
                        var d = w[c], e = d.name, k = CKEDITOR.dtd[e], f = v.name && CKEDITOR.dtd[v.name];
                        f && !f[e] || a && k && !k[a] && CKEDITOR.dtd[a] ? e == v.name && (D(v, v.parent, 1), c--) : (b || (r(), b = 1), d = d.clone(), d.parent = v, v = d, w.splice(c, 1), c--)
                    }
                }

                function r() {
                    for (; H.length;)D(H.shift(), v)
                }
                ...
                function D(b, c, d) {
                    c = c || v || p;
                    var e = v;
                    void 0 === b.previous && (t(c, b) && (v = c, x.onTagOpen(l, {}), b.returnPoint = c = v), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (k = !1), "textarea" == b.name && (u = !1));
                ...
                var x = new CKEDITOR.htmlParser,
                    p = h instanceof CKEDITOR.htmlParser.element ? h : "string" == typeof h ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment,
                    w = [], H = [], v = p, u = "textarea" == p.name, k = "pre" == p.name;
                x.onTagOpen = function (e, n, f, g) {
                    ...
                    if (a(n)) w.push(n); else {
                        ...
                        if ("br" == e) H.push(n); else {
                            for (; !(g = (f = v.name) ? CKEDITOR.dtd[f] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || v.isUnknown || g[e]);)if (v.isOptionalClose) x.onTagClose(f); else if (e in b && f in b) f = v.children, (f = f[f.length - 1]) && "li" == f.name || D(f = new CKEDITOR.htmlParser.element("li"), v), !n.returnPoint && (n.returnPoint = v), v = f; else if (e in CKEDITOR.dtd.$listItem && !z(e, f)) x.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !z(e, f)) !n.returnPoint && (n.returnPoint = v), v = v.parent; else if (f in CKEDITOR.dtd.$inline && w.unshift(v), v.parent) D(v, v.parent, 1); else {
                                n.isOrphan = 1;
                                break
                            }
                            m(e);
                ...
                x.onTagClose = function (a) {
                    ...
                    for (var c = [], d = [], e = v; e != p && e.name != a;)e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent;
                    if (e != p) {
                ...
                x.onText = function (a) {
                    if (!(v._.hasInlineStarted && !H.length || k || u) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length))return;
                    var b = v.name,
                        f = b ? CKEDITOR.dtd[b] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!u && !f["#"] && b in d) x.onTagOpen(e[b] || ""), x.onText(a); else {
                        r();
                        m();
                        k || u || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a);
                        if (t(v, a)) this.onTagOpen(l, {}, 0, 1);
                        v.add(a)
                    }
                };
                x.onCDATA =
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    g = Array.prototype.slice.call(arguments, 1), h = this.rules, l = h.length, m, r, f, D;
                for (D = 0; D < l; D++)if (d && (m = c.type, r = c.name), f = h[D], !(a.nonEditable && !f.options.applyToAll ||
                    a.nestedEditable && f.options.excludeNestedEditable)) {
                    f = f.value.apply(null, g);
                    if (!1 === f || d && f && (f.name != r || f.type != m))return f;
                    null != f && (g[0] = c = f)
                }
                return c
    ...
    (function () {
        function a(a, d) {
            ...
            function n(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [], n = b(e), u, E;
                        if (n)for (q(n, 1) && k.push(n); n;)g(n) && (u = c(n)) && q(u) && ((E = c(u)) && !g(E) ? k.push(u) : (f(y).insertAfter(u), u.remove())), n = n.previous;
                        for (n = 0; n < k.length; n++)k[n].remove();
                        if (k = !a || !1 !== ("function" == typeof d ? d(e) : d)) y || CKEDITOR.env.needsBrFiller ||
                        e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem) ? (k = b(e), k = !k || "form" == e.name && "input" == k.name) : k = !1 : k = !1;
                        k && e.add(f(a))
                    }
                }
            }
            ...
            var u = {elements: {}}, y = "html" == d, B = CKEDITOR.tools.extend({}, k), A;
            for (A in B)"#" in v[A] || delete B[A];
            for (A in B)u.elements[A] = n(y, a.config.fillEmptyBlocks);
            u.root = n(y, !1);
                    ...
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"]; else {
                            for (d = b.next; d && e(d);)d =
                                d.next;
                            var k = c(b);
                            !d && g(b.parent) ? h(b.parent, f(a)) : g(d) && k && !g(k) && f(a).insertBefore(d)
                        }
                    }
                }
            }(y);
        ...
        function p(a, b) {
            var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore =
                        {id: 1}), k = /<\!--\{cke_temp(comment)?\}(\d*?)--\x3e/g,
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, e) {
                return "\x3c" + c + d + "\x3e" + x(z(e), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, e, c = p(c, b), c = f(c, Q), c = r(c), c = f(c, Z), c = c.replace(O, "$1cke:$2"),
                ...
                var k;
                CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == e && (e = "div", c = "\x3cpre\x3e" + c + "\x3c/pre\x3e", k = 1);
                e = b.document.createElement(e);
                e.setHtml("a" + c);
                c = e.getHtml().substr(1);
                c = c.replace(new RegExp("data-cke-" + CKEDITOR.rnd + "-", "ig"), "");
                k && (c = c.replace(/^<pre>|<\/pre>$/gi, ""));
                c = c.replace(B, "$1$2");
                c = D(c);
                c = z(c);
                e = !1 === a.fixForBody ? !1 :
                ...
                e && (k = c, !k.children.length && CKEDITOR.dtd[k.name][e] && (e = new CKEDITOR.htmlParser.element(e), k.add(e)));
                a.dataValue = c
            }, null, null, 5);
            b.on("toHtml", function (a) {
            ...
            b.on("toHtml", function (a) {
                a.data.dataValue.filterChildren(k.dataFilter, !0)
            }, null, null, 10);
            b.on("toHtml", function (a) {
                a = a.data;
                var b = a.dataValue,
            ...
            b.on("toDataFormat", function (a) {
                a.data.dataValue.filterChildren(k.htmlFilter, !0)
            }, null, null, 10);
            b.on("toDataFormat", function (a) {
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var e = this.editor, k, n, f, q;
                b && "object" == typeof b ? (k = b.context, c = b.fixForBody, d = b.dontFilter, n = b.filter, f = b.enterMode, q = b.protectedWhitespaces) : k = b;
                k || null === k || (k = e.editable().getName());
                return e.fire("toHtml", {
                    dataValue: a, context: k, fixForBody: c, dontFilter: d,
                    filter: n || e.filter, enterMode: f || e.enterMode, protectedWhitespaces: q
                }).dataValue
        ...
        var w = /(?:&nbsp;|\xa0)$/, H = "{cke_protected}", v = CKEDITOR.dtd,
            u = "caption colgroup col thead tfoot tbody".split(" "), k = CKEDITOR.tools.extend({}, v.$blockLimit,
            v.$block), q = {
                elements: {
                    input: l,
                    textarea: l
                }
            }, n = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, y = {
                elements: {
                    embed: function (a) {
                        var b = a.parent;
                        if (b && "object" == b.name) {
        ...
        var J = /<(a|area|img|input|source)\b([^>]*)>/gi,
            G = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, C = /^(href|src|name)$/i,
            Z = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            Q = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, P = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            O = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            B = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, I = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var m, r;
                for (m in h) {
                    for (l = h[m]; ;)if (r = a.onAttributeName(b, m))if (r != m) delete h[m], m = r; else break; else {
                        delete h[m];
                        break
                    }
                    r && (!1 === (l = a.onAttribute(b, d, r, l)) ? delete h[r] :
                        h[r] = l)
                }
                ...
                b && this.filter(b);
                var g = this.name, h = [], l = this.attributes, m, r;
                a.openTag(g, l);
                for (m in l)h.push([m, l[m]]);
                a.sortAttributes && h.sort(d);
                m = 0;
                for (r = h.length; m < r; m++)l = h[m], a.attribute(l[0], l[1]);
                ...
                for (h = 0; h < this.children.length; h++) {
                    ...
                    "function" == typeof a && a(l) ? d.push(l) : "string" == typeof a && l.name === a && d.push(l);
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, d = a.element, h = a.elementMode, l =
                    a.fire("uiSpace", {space: "top", html: ""}).html, m = a.fire("uiSpace", {
                    space: "bottom",
                    html: ""
                }).html,
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && h && h[a]) {
                ...
                if (d.mode) {
                    var l = d.checkDirty(), h = d._.previousModeData, m, r = 0;
                    d.fire("beforeModeUnload");
                    d.editable(0);
                    d._.previousMode = d.mode;
                    d._.previousModeData = m = d.getData(1);
                    "source" == d.mode && h == m && (d.fire("lockSnapshot", {forceUpdate: !0}), r = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, h) {
            var l = this.container, m = this.ui.space("contents"),
            ...
            h.setSize("width", a, !0);
            r && (r.style.width = "1%");
            var f = (h.$.offsetHeight || 0) - (m.$.clientHeight ||
                0), l = Math.max(b - (d ? 0 : f), 0);
            b = d ? b + f : b;
            m.setStyle("height", l + "px");
            r && (r.style.width = "100%");
            this.fire("resize", {outerHeight: b, contentsHeight: l, outerWidth: a || h.getSize("width")})
        };
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, n = e.blockLimit, f = a.data.selection, g = f.getRanges()[0], l;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)if (f = d(f, e)) f.appendBogus(), l = CKEDITOR.env.ie;
            h(b, e.block, n) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), n = new CKEDITOR.dom.walker(e), n.guard = function (a) {
                return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
            }, !n.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
            (b = g.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), l = 1, a.cancel());
            l && g.select()
        }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    var b =
                        Array.prototype.slice.call(arguments, 1), b = a.on.apply(a, b);
                ...
                fixInitialSelection: function () {
                    ...
                    var c = v, d = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
                    ...
                    } else c.autoParagraph(this.editor, a), t(a.startContainer) && a.startContainer.appendBogus();
                    ...
                    if (!this.is("textarea")) {
                        ...
                        var n = a.config.contentsLangDirection;
                        this.getDirection(1) != n && this.changeAttr("dir", n);
                        var h = CKEDITOR.getCss();
                        if (h) {
                            var n = e.getHead(), l = n.getCustomData("stylesheet");
                            l ? h != l.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? l.$.styleSheet.cssText = h : l.setText(h)) : (h = e.appendStyleText(h), h = new CKEDITOR.dom.element(h.ownerNode || h.owningElement), n.setCustomData("stylesheet", h), h.data("cke-temp", 1))
                        }
                        n = e.getCustomData("stylesheet_ref") || 0;
                        e.setCustomData("stylesheet_ref",
                            n + 1);
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in J) {
                                b = a.getSelection();
                                var e, k = b.getRanges()[0], n = k.startPath(), q, h, y, c = 8 == c;
                                CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (e =
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup",
                            function (b) {
                                b.data.getKeystroke() in J && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select())
                            });
                        ...
                        CKEDITOR.env.webkit && (this.attachListener(this,
                            "click", function (a) {
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (b in J) {
                                ...
                                if (d.collapsed)a:{
                                    var e = b.block;
                                    if (e && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(e,
                                            !c) && d.collapsed) {
                                    ...
                                    k = b.block, d = c.endPath().block, k && d && !k.equals(d) ? (a.fire("saveSnapshot"), (e = k.getBogus()) && e.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(k, !1), b.lastElement.mergeSiblings(), r(k, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b)return;
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            b.on("mode", function () {
                ...
                if (a && a.isInline()) {
                    ...
                    if (d && (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" :
                            "contents"))) {
        ...
        p = function () {
            ...
            function b(c, d) {
                var e, f, n, g, q = [], h = d.range.startContainer;
                e = d.range.startPath();
                for (var h = p[h.getName()], y = 0, l = c.getChildren(), A = l.count(), J = -1, m = -1, r = 0, C = e.contains(p.$list); y < A; ++y)e = l.getItem(y), a(e) ? (n = e.getName(), C && n in CKEDITOR.dtd.$list ? q = q.concat(b(e, d)) : (g = !!h[n], "br" != n || !e.data("cke-eol") || y && y != A - 1 || (r = (f = y ? q[y - 1].node : l.getItem(y + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && p.$block[f.getName()]), -1 != J || g || (J = y), g || (m = y), q.push({
                    isElement: 1,
                    isLineBreak: r, isBlock: e.isBlockBoundary(), hasBlockSibling: f, node: e, name: n, allowed: g
                }), f = r = 0)) : q.push({isElement: 0, node: e, allowed: 1});
                -1 < J && (q[J].firstNotAllowed = 1);
                -1 < m && (q[m].lastNotAllowed = 1);
                return q
            }

            function d(b, c) {
                var e = [], f = b.getChildren(), k = f.count(), n, g = 0, h = p[c], y = !b.is(p.$inline) || b.is("br");
                for (y && e.push(" "); g < k; g++)n = f.getItem(g), a(n) && !n.is(h) ? e = e.concat(d(n, c)) : e.push(n);
                y && e.push(" ");
                return e
            }
            ...
            function f(b) {
                return b &&
                    a(b) && (b.is(p.$removeEmpty) || b.is("a") && !b.isBlockBoundary())
            }

            function g(b, c, d, e) {
                var f = b.clone(), k, n;
                f.setEndAt(c, CKEDITOR.POSITION_BEFORE_END);
                (k = (new CKEDITOR.dom.walker(f)).next()) && a(k) && m[k.getName()] && (n = k.getPrevious()) && a(n) && !n.getParent().equals(b.startContainer) && d.contains(n) && e.contains(k) && k.isIdentical(n) && (k.moveChildren(n), k.remove(), g(b, c, d, e))
            }
            ...
            var p = CKEDITOR.dtd, m = {
                ...
                dl: 1,
                blockquote: 1
            }, r = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, w = CKEDITOR.tools.extend({}, p.$inline);
            delete w.br;
            return function (m, C, B, I) {
                var E = m.editor, K = !1;
                "unfiltered_html" == C && (C = "html", K = !0);
                if (!I.checkReadOnly()) {
                    var F = (new CKEDITOR.dom.elementPath(I.startContainer, I.root)).blockLimit ||
                        I.root;
                    m = {
                        type: C,
                        dontFilter: K,
                    ...
                    I = m.mergeCandidates;
                    var L, t;
                    "text" == m.type && C.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (L = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", C.document), C.insertNode(L), C.setStartAfter(L));
                    K = new CKEDITOR.dom.elementPath(C.startContainer);
                    m.endPath = F = new CKEDITOR.dom.elementPath(C.endContainer);
                    if (!C.collapsed) {
                        var E = F.block || F.blockLimit, D = C.getCommonAncestor();
                        E && !E.equals(D) && !E.contains(D) && C.checkEndOfBlock() && m.zombies.push(E);
                        C.deleteContents()
                    }
                    for (; (t = e(C)) && a(t) && t.isBlockBoundary() && K.contains(t);)C.moveToPosition(t, CKEDITOR.POSITION_BEFORE_END);
                    g(C, m.blockLimit, K, F);
                    L && (C.setEndBefore(L), C.collapse(), L.remove());
                    L = C.startPath();
                    if (E = L.contains(f, !1, 1)) C.splitElement(E), m.inlineStylesRoot = E, m.inlineStylesPeak = L.lastElement;
                    L = C.createBookmark();
                    (E = L.startNode.getPrevious(c)) && a(E) && f(E) && I.push(E);
                    (E = L.startNode.getNext(c)) && a(E) && f(E) && I.push(E);
                    for (E = L.startNode; (E =
                        E.getParent()) && f(E);)I.push(E);
                    C.moveToBookmark(L);
                    if (L = B) {
                        L = m.range;
                        if ("text" == m.type && m.inlineStylesRoot) {
                            t = m.inlineStylesPeak;
                            C = t.getDocument().createText("{cke-peak}");
                            for (I = m.inlineStylesRoot.getParent(); !t.equals(I);)C = C.appendTo(t.clone()), t = t.getParent();
                            B = C.getOuterHtml().split("{cke-peak}").join(B)
                        }
                        t = m.blockLimit.getName();
                        if (/^\s+|\s+$/.test(B) && "span" in CKEDITOR.dtd[t]) {
                            var z = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            B = z + B + z
                        }
                        B = m.editor.dataProcessor.toHtml(B, {
                            context: null,
                            fixForBody: !1,
                        ...
                        t = L.document.createElement("body");
                        t.setHtml(B);
                        z && (t.getFirst().remove(), t.getLast().remove());
                        if ((z = L.startPath().block) && (1 != z.getChildCount() || !z.getBogus()))a:{
                            var v;
                            if (1 == t.getChildCount() && a(v = t.getFirst()) && v.is(r) && !v.hasAttribute("contenteditable")) {
                                z = v.getElementsByTag("*");
                                L = 0;
                                for (I = z.count(); L < I; L++)if (C = z.getItem(L), !C.is(w))break a;
                                v.moveChildren(v.getParent(1));
                                v.remove()
                            }
                        }
                        m.dataWrapper = t;
                    ...
                    if (L) {
                        ...
                        var S, X;
                        C = v.startContainer;
                        var K = m.endPath.elements[0], Y, F = K.getPosition(C),
                            D = !!K.getCommonAncestor(C) && F != CKEDITOR.POSITION_IDENTICAL && !(F & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        C = b(m.dataWrapper, m);
                        for (J(C, v); I < C.length; I++) {
                            F = C[I];
                            if (x = F.isLineBreak) {
                                x = v;
                                S = t;
                                var U = void 0, ba = void 0;
                                F.hasBlockSibling ? x = 1 : (U = x.startContainer.getAscendant(p.$block, 1)) && U.is({
                                    div: 1,
                                    p: 1
                                }) ? (ba =
                                    U.getPosition(S), ba == CKEDITOR.POSITION_IDENTICAL || ba == CKEDITOR.POSITION_CONTAINS ? x = 0 : (S = x.splitElement(U), x.moveToPosition(S, CKEDITOR.POSITION_AFTER_START), x = 1)) : x = 0
                            }
                            if (x) B = 0 < I; else {
                                x = v.startPath();
                                !F.isBlock && h(m.editor, x.block, x.blockLimit) && (H = l(m.editor)) && (H = L.createElement(H), H.appendBogus(), v.insertNode(H), CKEDITOR.env.needsBrFiller && (N = H.getBogus()) && N.remove(), v.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END));
                                if ((x = v.startPath().block) && !x.equals(M)) {
                                    if (N = x.getBogus()) N.remove(), z.push(x);
                                    M = x
                                }
                                F.firstNotAllowed && (E = 1);
                                if (E && F.isElement) {
                                    x = v.startContainer;
                                    for (S = null; x && !p[x.getName()][F.name];) {
                                        if (x.equals(t)) {
                                            x = null;
                                            break
                                        }
                                    ...
                                    if (x) S && (X = v.splitElement(S), m.zombies.push(X), m.zombies.push(S)); else {
                                        S = t.getName();
                                        Y = !I;
                                        x = I == C.length - 1;
                                        S = d(F.node, S);
                                        for (var U = [], ba = S.length, ca = 0, ea = void 0, fa = 0, ha = -1; ca < ba; ca++)ea = S[ca], " " == ea ? (fa || Y && !ca || (U.push(new CKEDITOR.dom.text(" ")), ha = U.length), fa = 1) : (U.push(ea), fa = 0);
                                        x && ha == U.length && U.pop();
                                        Y = U
                                    }
                                }
                                if (Y) {
                                    for (; x = Y.pop();)v.insertNode(x);
                                    Y = 0
                                } else v.insertNode(F.node);
                                F.lastNotAllowed && I < C.length - 1 && ((X = D ? K : X) && v.setEndAt(X, CKEDITOR.POSITION_AFTER_START), E = 0);
                                v.collapse()
                            }
                        }
                        1 != C.length ? N = !1 : (N = C[0], N = N.isElement && "false" == N.node.getAttribute("contenteditable"));
                        N && (B = !0, x = C[0].node, v.setStartAt(x, CKEDITOR.POSITION_BEFORE_START), v.setEndAt(x, CKEDITOR.POSITION_AFTER_END));
                        m.dontMoveCaret = B;
                    ...
                    for (Y = N.createBookmark(); M = m.zombies.pop();)M.getParent() && (H = N.clone(), H.moveToElementEditStart(M),
                        H.removeEmptyBlocksAtEnd());
                    if (X)for (; M = X.pop();)CKEDITOR.env.needsBrFiller ? M.appendBogus() : M.append(N.document.createText(" "));
                    for (; M = m.mergeCandidates.pop();)M.mergeSiblings();
                    N.moveToBookmark(Y);
                    if (!m.dontMoveCaret) {
                        for (M = e(N); M && a(M) && !M.is(p.$empty);) {
                            if (M.isBlockBoundary()) N.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END); else {
                                ...
                                T = N.clone();
                                T.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END)
                            }
                            M = M.getLast(c)
                        }
                        T && N.moveToRange(T)
        ...
        w = function () {
            ...
            return function (d) {
                var e =
                    d.startContainer, f = e.getAscendant("table", 1), g = !1;
                ...
                f.is("table") ? (d.setStartAt(f, CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), f.remove()) : (f.is({
                    ...
                    thead: 1,
                    tfoot: 1
                }) && (f = b(f, "tr", g)), f.is("tr") && (f = b(f, f.getParent().is("thead") ? "th" : "td", g)), (e = f.getBogus()) && e.remove(), d.moveToPosition(f, g ? CKEDITOR.POSITION_AFTER_START :
                    CKEDITOR.POSITION_BEFORE_END))
            }
        }();
        H = {
            eol: {
                detect: function (a, b) {
                    ...
                    a.appendEolBr && (d = this.createEolBr(c),
                        a.fragment.append(d));
                ...
                rebuild: function (a, b) {
                    var c = a.range, d = c.getCommonAncestor(), e = new CKEDITOR.dom.elementPath(d, b),
                        f = new CKEDITOR.dom.elementPath(c.startContainer, b),
                        c = new CKEDITOR.dom.elementPath(c.endContainer,
                            b), g;
        ...
        v = function () {
            ...
            function b(c, d, e) {
                a(d);
                a(e, 1);
                for (var f; f = e.getNext();)f.insertAfter(d), d =
                    f;
                t(c) && c.remove()
            }
                ...
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(),
                            k = e.contains(CKEDITOR.dtd.$list), g = f.contains(CKEDITOR.dtd.$list);
                        a.mergeList = k && g && k.getParent().equals(g.getParent()) && !k.equals(g);
                        a.mergeListItems = e.block && f.block && e.block.is(CKEDITOR.dtd.$listItem) && f.block.is(CKEDITOR.dtd.$listItem);
                        if (a.mergeList || a.mergeListItems) d = d.clone(),
                        ...
                        if (a.mergeListBookmark) {
                            ...
                            if (a.mergeList) {
                                var h = f.contains(CKEDITOR.dtd.$list), q = g.contains(CKEDITOR.dtd.$list);
                                h.equals(q) || (q.moveChildren(h), q.remove())
                            }
                            a.mergeListItems && (f = f.contains(CKEDITOR.dtd.$listItem), g = g.contains(CKEDITOR.dtd.$listItem),
                            f.equals(g) || b(g, d, e));
                            d.remove();
                            e.remove()
                        }
                    ...
                    function a(c) {
                        var e = [], f, k = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d),
                            n = c.endPath().contains(d), h = {};
                        k.guard = function (a, k) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) {
                                var q = "visited_" + (k ? "out" : "in");
                                if (a.getCustomData(q))return;
                                CKEDITOR.dom.element.setMarker(h, a, q, 1)
                            }
                            if (k && g && a.equals(g)) f = c.clone(), f.setEndAt(g, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!k && n && a.equals(n)) f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START),
                                e.push(f); else {
                                if (q = !k) q = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!n || b(a, n));
                                q && (f = c.clone(), f.selectNodeContents(a), e.push(f))
                            }
                        };
                        k.lastForward();
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var k = c(f, e.bookmark), g = k.clone(), h, l, m = k.getCommonAncestor();
                            m.is(CKEDITOR.dtd.$tableContent) && !m.is(d) && (m = m.getAscendant("table",
                                !0));
                            l = m;
                            m = new CKEDITOR.dom.elementPath(k.startContainer, l);
                            l = new CKEDITOR.dom.elementPath(k.endContainer, l);
                            m = m.contains("table");
                            l = l.contains("table");
                            if (m || l) m && l && b(m, l) ? (e.tableSurroundingRange = g, g.setStartAt(m, CKEDITOR.POSITION_AFTER_END), g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), g = k.clone(), g.setEndAt(m, CKEDITOR.POSITION_AFTER_END), h = k.clone(), h.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), h = a(g).concat(a(h))) : m ? l || (e.tableSurroundingRange = g, g.setStartAt(m, CKEDITOR.POSITION_AFTER_END), k.setEndAt(m,
                                    CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = g, g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), k.setStartAt(l, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = h ? h : a(k)
                        }, deleteRanges: function (a) {
                            for (var b; b = a.tableContentsRanges.pop();)b.extractContents(), t(b.startContainer) && b.startContainer.appendBogus();
                    ...
                    var c = b.startPath(), d;
                    h(a, c.block, c.blockLimit) && (d = l(a)) && (d = b.document.createElement(d), d.appendBogus(),
    ...
    (function () {
        ...
        function d() {
            w = !0;
            p || (b.call(this), p = CKEDITOR.tools.setTimeout(b, 200, this))
        }

        function b() {
            p = null;
            w && (CKEDITOR.tools.setTimeout(a, 0, this), w = !1)
        }
        ...
        function e(a) {
            ...
            var d = a.startContainer, e = a.getPreviousNode(c, null, d), f = a.getNextNode(c, null,
                d);
        ...
        function l(a, b) {
            return b ? a.replace(x, function (a, b) {
                return b ? " " : ""
            }) : a.replace(z, "")
        }
        ...
        var D = "function" != typeof window.getSelection, t = 1, z = CKEDITOR.tools.repeat("​", 7),
            x = new RegExp(z + "( )?", "g"), p, w, H = CKEDITOR.dom.walker.invisible(1), v = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                function b() {
                    B = new CKEDITOR.dom.selection(e.getSelection());
                    B.lock()
                }
                ...
                var f = e.document, k = CKEDITOR.document, g = e.editable(), q = f.getBody(),
                    l = f.getDocumentElement(), m = g.isInline(), p, B;
                ...
                if (CKEDITOR.env.ie || m) D ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
                    e.lockSelection(B);
                    p = 1
                            ...
                            l.on("mousedown", function (a) {
                                function b(a) {
                                    ...
                                    if (E) {
                                        ...
                                        E.setEndPoint(0 > K.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        E.select()
                                    }
                                }
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = D ? this.document.$.selection : this.document.getWindow().$.getSelection()
            }, getType: D ? function () {
                var a = this._.cache;
                ...
                var a = D ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, k = b.duplicate(), h = 0, l = e.length - 1, B = -1, n, m; h <= l;)if (B = Math.floor((h + l) / 2), f = e[B], k.moveToElementText(f), n = k.compareEndPoints("StartToStart", b), 0 < n) l = B - 1; else if (0 > n) h = B + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        if (-1 == B || B == e.length - 1 && 0 > n) {
                            ...
                            for (d = e.length; 0 < k && 0 < d;)g = e[--d], g.nodeType == CKEDITOR.NODE_TEXT && (m = g, k -= g.nodeValue.length);
                            return {container: m, offset: -k}
                        }
                        k.collapse(0 < n ? !0 : !1);
                        k.setEndPoint(0 < n ? "StartToStart" : "EndToStart", b);
                        k = k.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!k)return {container: d, offset: a(f) + (0 < n ? 0 : 1)};
                        for (; 0 < k;)try {
                            g = f[0 < n ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (k -= g.nodeValue.length,
                                m = g), f = g
                        } catch (p) {
                            return {container: d, offset: a(f)}
                        }
                        return {container: m, offset: 0 < n ? -k : m.nodeValue.length + k}
                    };
                    return function () {
                        ...
                        if (d == CKEDITOR.SELECTION_ELEMENT) {
                            for (var d = [], e = 0; e < c.length; e++) {
                                ...
                                a.setEnd(new CKEDITOR.dom.node(g), k + 1);
                                d.push(a)
                            }
                            return d
                        }
                ...
                var b = this.getNative(), b = D ? "Control" == b.type ? "" : b.createRange().text : b.toString();
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    a:{
                        var m, p;
                        if (1 == a.length && !(p = a[0]).collapsed && (l = p.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (p = p.clone(), p.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (m = p.getEnclosedNode()) && m.type == CKEDITOR.NODE_ELEMENT && (l = m), "false" == l.getAttribute("contenteditable")))break a;
                        l = void 0
                    }
                    if (l) this.fake(l); else {
                        if (D) {
                            ...
                            a = l.collapsed;
                            var r, t, x;
                            if ((c = l.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT &&
                                c.getName() in u && (!c.is("a") || !c.getText()))try {
                            ...
                            b = x.startNode;
                            a || (f = x.endNode);
                            x = l.document.$.body.createTextRange();
                            x.moveToElementText(b.$);
                            x.moveStart("character", 1);
                            f ? (m = l.document.$.body.createTextRange(),
                                m.moveToElementText(f.$), x.setEndPoint("EndToEnd", m), x.moveEnd("character", -1)) : (r = b.getNext(p), t = b.hasAscendant("pre"), r = !(r && r.getText && r.getText().match(m)) && (t || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), t = l.document.createElement("span"), t.setHtml("\x26#65279;"), t.insertBefore(b), r && l.document.createText("﻿").insertBefore(b));
                            l.setStartBefore(b);
                            b.remove();
                            a ? (r ? (x.moveStart("character", -1), x.select(), l.document.$.selection.clear()) : x.select(), l.moveToPosition(t, CKEDITOR.POSITION_BEFORE_START),
                                t.remove()) : (l.setEndBefore(f), f.remove(), x.select())
                        } else {
                            f = this.getNative();
                            if (!f)return;
                            this.removeAllRanges();
                            for (x = 0; x < a.length; x++) {
                                if (x < a.length - 1 && (r = a[x], t = a[x + 1], m = r.clone(), m.setStart(r.endContainer, r.endOffset), m.setEnd(t.startContainer, t.startOffset), !m.collapsed && (m.shrink(CKEDITOR.NODE_ELEMENT, !0), l = m.getCommonAncestor(), m = m.getEnclosedNode(), l.isReadOnly() || m && m.isReadOnly()))) {
                                ...
                                l.collapsed && CKEDITOR.env.webkit && e(l) && (m = g(this.root), l.insertNode(m), (r = m.getNext()) && !m.getPrevious() && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() ? (h(this.root), l.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START)) : l.moveToPosition(m, CKEDITOR.POSITION_AFTER_END));
                                t.setStart(l.startContainer.$, l.startOffset);
                                try {
                                    t.setEnd(l.endContainer.$, l.endOffset)
                                } catch (B) {
                                    if (0 <= B.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1), t.setEnd(l.endContainer.$, l.endOffset); else throw B;
                                }
                                f.addRange(t)
                            }
                        }
    ...
    (function () {
        ...
        function b(c) {
            ...
            if (c.collapsed) f = H(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var p = c.createBookmark(), q = p.startNode, r = p.endNode, t = q, u;
                if (!k) {
                    var z = c.getCommonAncestor(), k = a(q, z), z = a(r, z);
                    k && (t = k.getNextSourceNode(!0));
                    z && (r = z)
                }
                for (t.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                    k = !1;
                    if (t.equals(r)) t = null, k = !0; else {
                        var v = t.type == CKEDITOR.NODE_ELEMENT ? t.getName() : null,
                            z = v && "false" == t.getAttribute("contentEditable"), w = v &&
                                t.getAttribute("data-nostyle");
                        if (v && t.data("cke-bookmark")) {
                            t = t.getNextSourceNode(!0);
                            continue
                        }
                        if (z && m && CKEDITOR.dtd.$block[v])for (var D = t, y = e(D), A = void 0, C = y.length, G = 0, D = C && new CKEDITOR.dom.range(D.getDocument()); G < C; ++G) {
                            var A = y[G], J = CKEDITOR.filter.instances[A.data("cke-filter")];
                            if (J ? J.check(this) : 1) D.selectNodeContents(A), b.call(this, D)
                        }
                        y = v ? !n[v] || w ? 0 : z && !m ? 0 : d(t, r, h, P) : 1;
                        if (y)if (A = t.getParent(), y = h, C = g, G = l, !A || !(A.getDtd() || CKEDITOR.dtd.span)[C] && !G || y.parentRule && !y.parentRule(A)) k = !0; else {
                            if (u ||
                                v && CKEDITOR.dtd.$removeEmpty[v] && (t.getPosition(r) | P) != P || (u = c.clone(), u.setStartBefore(t)), v = t.type, v == CKEDITOR.NODE_TEXT || z || v == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) {
                                for (var v = t, Q; (k = !v.getNext(Z)) && (Q = v.getParent(), n[Q.getName()]) && d(Q, q, h, O);)v = Q;
                                u.setEndAfter(v)
                            }
                        } else k = !0;
                        t = t.getNextSourceNode(w || z)
                    }
                    if (k && u && !u.collapsed) {
                        for (var k = H(this, f), z = k.hasAttributes(), w = u.getCommonAncestor(), v = {}, y = {}, A = {}, C = {}, T, W, da; k && w;) {
                            if (w.getName() == g) {
                                for (T in h.attributes)!C[T] && (da = w.getAttribute(W)) &&
                                (k.getAttribute(T) == da ? y[T] = 1 : C[T] = 1);
                                for (W in h.styles)!A[W] && (da = w.getStyle(W)) && (k.getStyle(W) == da ? v[W] = 1 : A[W] = 1)
                            }
                            w = w.getParent()
                        }
                        for (T in y)k.removeAttribute(T);
                        for (W in v)k.removeStyle(W);
                        z && !k.hasAttributes() && (k = null);
                        k ? (u.extractContents().appendTo(k), u.insertNode(k), x.call(this, k), k.mergeSiblings(), CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"), u.extractContents().appendTo(k), u.insertNode(k), x.call(this, k), k.remove(!0));
                        u = null
                    }
                }
                c.moveToBookmark(p);
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0, h; g < e.elements.length && (h = e.elements[g]) && h != e.block && h != e.blockLimit; g++)if (this.checkElementRemovable(h)) {
                    var l;
                    a.collapsed && (a.checkBoundaryOfElement(h, CKEDITOR.END) || (l = a.checkBoundaryOfElement(h, CKEDITOR.START))) ? (f = h, f.match = l ? "start" : "end") : (h.mergeSiblings(), h.is(this.element) ? z.call(this, h) : p(h, k(this)[h.getName()]))
                }
                if (f) {
                    h = d;
                    for (g = 0; ; g++) {
                ...
                b();
                for (e = d; !e.equals(m);)f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? z.call(this, e) : p(e, k(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f
            }
            a.moveToBookmark(c);
        ...
        function l(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = H(this, e, d), r(d, f));
            a.moveToBookmark(b)
        }
        ...
        function r(a, b) {
            ...
            if (d && !e) {
                ...
                b = e
            } else g ? b = t(c ? [a.getHtml()] : f(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, k;
                (k = c.getPrevious(Q)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = D(k.getHtml(), /\n$/, "") + "\n\n" + D(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" :
        ...
        function z(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = k(this)[a.getName()],
                f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), g;
            for (g in d)if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == q(g, d[g])) b && "data-" == g.slice(0, 5) || (f = a.hasAttribute(g), a.removeAttribute(g));
        ...
        function x(a) {
            for (var b = k(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0);
        ...
        function w(a, b) {
            if (!a.hasAttributes() || b)if (CKEDITOR.dtd.$block[a.getName()]) {
                var c = a.getPrevious(Q), d = a.getNext(Q);
        ...
        var A = {
            ...
            audio: 1,
            video: 1
        }, G = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, Z = CKEDITOR.dom.walker.bookmark(0,
            1), Q = CKEDITOR.dom.walker.whitespaces(1);
        CKEDITOR.style = function (a, b) {
            if ("string" == typeof a.type) {
                console.info(CKEDITOR.style.customHandlers[a.type]);
            ...
            this.type = a.type || (A[c] ? CKEDITOR.STYLE_BLOCK : J[c] ? CKEDITOR.STYLE_OBJECT :
        ...
        CKEDITOR.style.prototype = {
            apply: function (a) {
                ...
                if (this.checkApplicable(a.elementPath(), a)) {
                    ...
                    y.call(this, a.getSelection(), 0, a);
                    this._.enterMode = b
                }
            }, remove: function (a) {
                if (a instanceof CKEDITOR.dom.document)return y.call(this, a.getSelection(), 1);
                if (this.checkApplicable(a.elementPath(),
                        a)) {
                    var b = this._.enterMode;
                    b || (this._.enterMode = a.activeEnterMode);
                    y.call(this, a.getSelection(), 1, a);
                    this._.enterMode = b
                }
                ...
                this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? m : this.type == CKEDITOR.STYLE_OBJECT ? h : null;
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var h in c)if ("_length" != h)if (d = a.getAttribute(h) || "", "style" == h ? n(c[h], d) : c[h] == d) {
                            if (!b)return !0
                        } else if (b)return !1;
                        if (b)return !0
                    } else return !0
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (b, e) {
            var g = null, h = null, l = [], m = b, r;
            e = e || b.getDocument().getBody();
            do if (m.type == CKEDITOR.NODE_ELEMENT) {
                l.push(m);
                if (!this.lastElement && (this.lastElement = m, m.is(CKEDITOR.dtd.$object) || "false" == m.getAttribute("contenteditable")))continue;
                if (m.equals(e))break;
                if (!h && (r = m.getName(),
                        "true" == m.getAttribute("contenteditable") ? h = m : !g && d[r] && (g = m), a[r])) {
                    if (r = !g && "div" == r) {
                        a:{
                            r = m.getChildren();
                            for (var f = 0, D = r.count(); f < D; f++) {
                                var t = r.getItem(f);
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, h = c[d ? "endContainer" : "startContainer"], l = d ? "endOffset" : "startOffset",
                m = g ? c.document.getById(a.startNode) : a.startNode;
            a = g ? c.document.getById(a.endNode) : a.endNode;
            h.equals(m.getPrevious()) ? (c.startOffset = c.startOffset - h.getLength() - a.getPrevious().getLength(), h = a.getNext()) : h.equals(a.getPrevious()) && (c.startOffset -= h.getLength(), h = a.getNext());
            h.equals(m.getParent()) && c[l]++;
            ...
            createIterator: function () {
                ...
                return {
                    getNextRange: function (h) {
                        ...
                        var l = a[g];
                        if (l && 1 < a.length) {
                            if (!g)for (var m = a.length - 1; 0 <= m; m--)d.unshift(a[m].createBookmark(!0));
                            if (h)for (var r = 0; a[g + r + 1];) {
                                var f = l.document;
                                h = 0;
                                m = f.getById(d[r].endNode);
                                for (f = f.getById(d[r + 1].startNode); ;) {
                                    m =
                                        m.getNextSourceNode(!1);
                                    if (f.equals(m)) h = 1; else if (c(m) || m.type == CKEDITOR.NODE_ELEMENT && m.isBlockBoundary())continue;
                                    break
                                }
                                if (!h)break;
                                r++
    ...
    (function () {
        ...
        var h = "cke_ui_color", l = [], m = /\$color/g;
            ...
            if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
                ...
                a = function (a) {
                    ...
                    if (!a.getById("cke_ui_color")) {
                        ...
                        l.push(a);
                        var d = b.getUiColor();
                        d && e([a], CKEDITOR.skin.chameleon(b, "panel"), [[m, d]])
                    }
                };
                b.on("panelShow", a);
                b.on("menuShow", a);
    ...
    (function () {
        ...
        function y(b) {
            ...
            function d() {
                return {
                    canUndo: !1,
                    async: !0, fakeKeystroke: CKEDITOR.CTRL + 86, exec: function (b, a) {
                        var d = this, c = function (a, c) {
                            a && r(b, a, !!c);
            ...
            function f(a) {
                ...
                c.on(a, f);
                7 < CKEDITOR.env.version ? d.$.execCommand(a) :
                    d.$.selection.createRange().execCommand(a);
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    CKEDITOR.env.webkit ? (e.append(m), m.addClass("cke_editable"), e.is("body") || (k = "static" != e.getComputedStyle("position") ? e : CKEDITOR.dom.element.get(e.$.offsetParent), k = k.getDocumentPosition().y)) : e.getAscendant(CKEDITOR.env.ie ?
                        "body" : "html", 1).append(m);
                    m.setStyles({
                        position: "absolute",
                    ...
                    if (CKEDITOR.env.webkit ||
                        CKEDITOR.env.gecko) q = e.once("blur", f, null, null, -100);
                    k && m.focus();
                    ...
                    setTimeout(function () {
                        ...
                        m.remove();
                        var a;
                        CKEDITOR.env.webkit && (a = m.getFirst()) && a.is && a.hasClass("Apple-style-span") &&
                        (m = a);
            ...
            b.getClipboardData = function (a, d) {
                ...
                !1 === z() && (b.removeListener("paste", c), q && b.fire("pasteDialog",
                    f) ? (b.on("pasteDialogCommit", e), b.on("dialogHide", function (a) {
                    a.removeListener();
        ...
        function F(b) {
            ...
            b.on("contentDom", function () {
                ...
                var f = b.editable(), h = CKEDITOR.plugins.clipboard.getDropTarget(b), l = b.ui.space("top"),
                    p = b.ui.space("bottom");
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "dialog", init: function (b) {
                ...
                b.on("paste", function (a) {
                    ...
                    -1 < b.indexOf("Apple-") && (b = b.replace(/<span class="Apple-converted-space">&nbsp;<\/span>/gi, " "), "html" != a.data.type && (b = b.replace(/<span class="Apple-tab-span"[^>]*>([^<]*)<\/span>/gi,
                        function (a, b) {
                    ...
                    if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                        ...
                        for (l.setHtml(b); 1 == l.getChildCount() && (f = l.getFirst()) && f.type == CKEDITOR.NODE_ELEMENT && (f.hasClass("cke_editable") ||
                        f.hasClass("cke_contents"));)l = h = f;
                ...
                b.on("paste", function (a) {
                        a = a.data;
                        var e = a.type, g = a.dataValue, f, h = b.config.clipboard_defaultContentType ||
                            "html", l = a.dataTransfer.getTransferType(b);
        ...
        CKEDITOR.plugins.clipboard.dataTransfer =
            function (b, a) {
                ...
                a && (this.sourceEditor = a, this.setData("text/html", a.getSelectedHtml(1)), "Text" ==
                p || this.getData("text/plain") || this.setData("text/plain", a.getSelection().getSelectedText()))
            };
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function (b) {
                ...
                "text/html" == b ? (a = a.replace(this._.metaRegExp, ""), (b = this._.bodyRegExp.exec(a)) &&
                b.length && (a = b[1], a = a.replace(this._.fragmentRegExp, ""))) : "Text" == b && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == a.substring(0, 7) && (a = "");
                return a
                ...
                return this.sourceEditor ? this.sourceEditor == b ? CKEDITOR.DATA_TRANSFER_INTERNAL : CKEDITOR.DATA_TRANSFER_CROSS_EDITORS :
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (a, b, c, l) {
                ...
                addBlock: function (a, b) {
                    ...
                    var k = this.element, e = this._.iframe,
                        e = CKEDITOR.env.ie && !CKEDITOR.env.edge ? e : new CKEDITOR.dom.window(e.$.contentWindow),
                        f = k.getDocument(), r = this._.parentElement.getPositionedAncestor(),
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            var b = m.element.getWindow(), a = k.$.getBoundingClientRect(), b = b.getViewPaneSize(),
                                c = a.width || a.right - a.left, e = a.height || a.bottom - a.top,
                                l = q ? a.right : b.width - a.left, h = q ? b.width - a.right : a.left;
    ...
    CKEDITOR.plugins.add("colorbutton", {
        requires: "panelbutton,floatpanel", init: function (d) {
            function r(a, f, c, e, h) {
                var m = new CKEDITOR.style(k["colorButton_" + f + "Style"]),
                ...
                d.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
                    ...
                    allowedContent: m,
                    requiredContent: m,
                    contentTransformations: h.contentTransformations,
                    panel: {
                    ...
                    onBlock: function (n,
                        ...
                        b.element.setHtml(u(n, f, l));
                        b.element.getDocument().getBody().setStyle("overflow", "hidden");
                        CKEDITOR.ui.fire("ready", this);
                        var a = b.keys, c = "rtl" == d.lang.dir;
                        a[c ? 37 : 39] = "next";
                        a[40] = "next";
                        a[9] = "next";
                        a[c ? 39 : 37] = "prev";
                    ...
                    refresh: function () {
                        d.activeFilter.check(m) || this.setState(CKEDITOR.TRISTATE_DISABLED)
                    },
                    onOpen: function () {
                        var a = d.getSelection(), a = a && a.getStartElement(), a = d.elementPath(a), b;
                        if (a) {
                            a =
                                a.block || a.blockLimit || d.document.getBody();
                            do b = a && a.getComputedStyle("back" == f ? "background-color" : "color") || "transparent"; while ("back" == f && "transparent" == b && a && (a = a.getParent()));
                            b && "transparent" != b || (b = "#ffffff");
                            !1 !== k.colorButton_enableAutomatic && this._.panel._.iframe.getFrameDocument().getById(l).setStyle("background-color", b);
                            return b
                        }
                    }
                })
            ...
            function u(a, f, c) {
                var e = [], h = k.colorButton_colors.split(","),
                    m = d.plugins.colordialog && !1 !== k.colorButton_enableMore, l = h.length + (m ? 2 : 1),
                    n = CKEDITOR.tools.addFunction(function (b,
                                                             c) {
                        function e(a) {
                            this.removeListener("ok", e);
                            this.removeListener("cancel", e);
                            "ok" == a.name && g(this.getContentElement("picker", "selectedColor").getValue(), c)
                        }

                        var g = arguments.callee;
                        if ("?" == b) d.openDialog("colordialog", function () {
                            this.on("ok", e);
                            this.on("cancel", e)
                        }); else {
                            d.focus();
                            a.hide();
                            d.fire("saveSnapshot");
                            d.removeStyle(new CKEDITOR.style(k["colorButton_" + c + "Style"], {color: "inherit"}));
                            if (b) {
                                var f = k["colorButton_" + c + "Style"];
                                f.childRule = "back" == c ? function (a) {
                                    return t(a)
                                } : function (a) {
                                    return !(a.is("a") ||
                                        a.getElementsByTag("a").count()) || t(a)
                                };
                                d.applyStyle(new CKEDITOR.style(f, {color: b}))
                            }
                            d.fire("saveSnapshot")
                        }
                    });
                !1 !== k.colorButton_enableAutomatic && e.push('\x3ca class\x3d"cke_colorauto" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', g.auto, '" onclick\x3d"CKEDITOR.tools.callFunction(', n, ",null,'", f, "');return false;\" href\x3d\"javascript:void('", g.auto, '\')" role\x3d"option" aria-posinset\x3d"1" aria-setsize\x3d"', l, '"\x3e\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e\x3ctr\x3e\x3ctd\x3e\x3cspan class\x3d"cke_colorbox" id\x3d"',
                    c, '"\x3e\x3c/span\x3e\x3c/td\x3e\x3ctd colspan\x3d7 align\x3dcenter\x3e', g.auto, "\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/a\x3e");
                e.push('\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e');
                for (c = 0; c < h.length; c++) {
                    0 === c % 8 && e.push("\x3c/tr\x3e\x3ctr\x3e");
                    var b = h[c].split("/"), p = b[0], q = b[1] || p;
                    b[1] || (p = "#" + p.replace(/^(.)(.)(.)$/, "$1$1$2$2$3$3"));
                    b = d.lang.colorbutton.colors[q] || q;
                    e.push('\x3ctd\x3e\x3ca class\x3d"cke_colorbox" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"',
                        b, '" onclick\x3d"CKEDITOR.tools.callFunction(', n, ",'", p, "','", f, "'); return false;\" href\x3d\"javascript:void('", b, '\')" role\x3d"option" aria-posinset\x3d"', c + 2, '" aria-setsize\x3d"', l, '"\x3e\x3cspan class\x3d"cke_colorbox" style\x3d"background-color:#', q, '"\x3e\x3c/span\x3e\x3c/a\x3e\x3c/td\x3e')
                }
                m && e.push('\x3c/tr\x3e\x3ctr\x3e\x3ctd colspan\x3d8 align\x3dcenter\x3e\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', g.more, '" onclick\x3d"CKEDITOR.tools.callFunction(',
                    n, ",'?','", f, "');return false;\" href\x3d\"javascript:void('", g.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', l, '" aria-setsize\x3d"', l, '"\x3e', g.more, "\x3c/a\x3e\x3c/td\x3e");
                e.push("\x3c/tr\x3e\x3c/table\x3e");
                return e.join("")
            }
            ...
            var k = d.config, g = d.lang.colorbutton;
            CKEDITOR.env.hc || (r("TextColor", "fore", g.textColorTitle, 10, {
                contentTransformations: [[{
                    element: "font", check: "span{color}", left: function (a) {
                ...
                add: function (a) {
                    ...
                    if (!e) {
                        ...
                        this._.itemOverFn = CKEDITOR.tools.addFunction(function (a) {
                            ...
                            this._.showSubTimeout = CKEDITOR.tools.setTimeout(this._.showSubMenu, k.config.menu_subMenuDelay ||
                                400, this, [a])
                        }, this);
                    ...
                    l(g);
                    for (var c = k.elementPath(), c = ['\x3cdiv class\x3d"cke_menu' + (c && c.direction() != k.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], h = g.length, n = h && g[0].group,
                             q = 0; q < h; q++) {
                        var p = g[q];
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a,
                ...
                render: function (a, b, d) {
                    ...
                    var u = this.getItems, q =
                        "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";", p = this.name;
    ...
    (function () {
        ...
        function k(a, b, e, d) {
            ...
            if (a = a.startContainer.getAscendant(b, !0) || a.endContainer.getAscendant(b, !0))if (e(a), d)return;
            for (; a = c.next();)if (a = a.getAscendant(b, !0))if (e(a), d)break
        }

        function t(a, b) {
            var e = {ul: "ol", ol: "ul"};
            return -1 !== m(b, function (b) {
        ...
        var m = CKEDITOR.tools.indexOf, r = !1;
        CKEDITOR.plugins.add("copyformatting", {
            lang: "en", icons: "copyformatting", hidpi: !0, init: function (a) {
                ...
                r || (CKEDITOR.document.appendStyleSheet(this.path + "styles/copyformatting.css"),
                    r = !0);
                ...
                a.on("contentDom", function () {
                    var e = a.editable(), b = e.isInline() ? e : a.document, c = a.ui.get("CopyFormatting");
                    e.attachListener(b, "mouseup", function (b) {
                        q(b) && a.execCommand("applyFormatting")
                    });
                    e.attachListener(CKEDITOR.document, "mouseup", function (b) {
                        var d = a.getCommand("copyFormatting");
                        q(b) && d.state === CKEDITOR.TRISTATE_ON && !e.contains(b.data.getTarget()) && a.execCommand("copyFormatting")
                    });
                    c && (b = CKEDITOR.document.getById(c._.id), e.attachListener(b, "dblclick", function () {
                        a.execCommand("copyFormatting", {sticky: !0})
                    }), e.attachListener(b, "mouseup", function (a) {
                ...
                a.copyFormatting.on("applyFormatting", function (e) {
                    if (!e.data.preventFormatStripping) {
                        var d = e.data.range, c = b._extractStylesFromRange(a, d), g = b._determineContext(d), f, h;
                        if (a.copyFormatting._isContextAllowed(g))for (h = 0; h < c.length; h++)g = c[h], f = d.createBookmark(), -1 === m(b.preservedElements, g.element) ? CKEDITOR.env.webkit && !CKEDITOR.env.chrome ? c[h].removeFromRange(e.data.range, e.editor) : c[h].remove(e.editor) : t(g.element, e.data.styles) && b._removeStylesFromElementInRange(d,
                                g.element), d.moveToBookmark(f)
                    }
                });
                a.copyFormatting.on("applyFormatting", function (b) {
                        var d = CKEDITOR.plugins.copyformatting, c = d._determineContext(b.data.range);
        ...
        l.prototype._isContextAllowed = function (a) {
        ...
        CKEDITOR.plugins.copyformatting = {
            ...
            commands: {
                copyFormatting: {
                    exec: function (a, b) {
                        var e = CKEDITOR.plugins.copyformatting, d = a.copyFormatting,
                            c = b ? "keystrokeHandler" == b.from : !1, g = b ? b.sticky || c : !1,
                            f = e._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
                        if (this.state === CKEDITOR.TRISTATE_ON)return d.styles = null, d.sticky = !1, f.removeClass("cke_copyformatting_active"), h.removeClass("cke_copyformatting_disabled"), h.removeClass("cke_copyformatting_tableresize_cursor"),
                        ...
                        c || (f.addClass("cke_copyformatting_active"), h.addClass("cke_copyformatting_tableresize_cursor"), a.config.copyFormatting_outerCursor && h.addClass("cke_copyformatting_disabled"));
                        d.sticky = g;
                    ...
                    exec: function (a, b) {
                        var e = a.getCommand("copyFormatting"), d = b ? "keystrokeHandler" ==
                                b.from : !1, c = CKEDITOR.plugins.copyformatting, g = a.copyFormatting,
                            f = c._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
                        if (d || e.state === CKEDITOR.TRISTATE_ON) {
                            if (d && !g.styles)return c._putScreenReaderMessage(a, "failed");
                            d = c._applyFormat(a, g.styles);
                            g.sticky || (g.styles = null, f.removeClass("cke_copyformatting_active"), h.removeClass("cke_copyformatting_disabled"), h.removeClass("cke_copyformatting_tableresize_cursor"), e.setState(CKEDITOR.TRISTATE_OFF));
            ...
            _convertElementToStyleDef: function (a) {
                var b = CKEDITOR.tools, e = a.getAttributes(CKEDITOR.plugins.copyformatting.excludedAttributes),
            ...
            _extractStylesFromElement: function (a, b) {
                var e = {}, d = [];
                do if (b.type === CKEDITOR.NODE_ELEMENT && !b.hasAttribute("data-cke-bookmark") &&
                    (e.element = b, a.copyFormatting.fire("extractFormatting", e, a) && e.styleDef && d.push(new CKEDITOR.style(e.styleDef)), b.getName && -1 !== m(CKEDITOR.plugins.copyformatting.breakOnElements, b.getName())))break; while ((b = b.getParent()) && b.type === CKEDITOR.NODE_ELEMENT);
                return d
            },
            ...
            _getSelectedWordOffset: function (a) {
                ...
                function d(a, c) {
                    ...
                    do {
                        ...
                        if (p && p.getName && -1 !== m(h, p.getName())) {
                            k = !0;
                            break
                        }
                        f = p
                    } while (f && f.getStyle && ("none" == f.getStyle("display") || !f.getText()));
                    for (f || (f = a); f.type !== CKEDITOR.NODE_TEXT;)f = !k || c || l ? f.getChild(0) : f.getChild(f.getChildCount() - 1);
                    for (h = e(f); null != (l = g.exec(h)) && (n = l.index, c););
                    if ("number" !== typeof n && !k)return d(f, c);
                    if (k) c ? n = 0 : (g = /([\.\b]*$)/, n = (l = g.exec(h)) ? l.index : h.length); else if (c && (n +=
                            1, n > h.length))return d(f);
                    return {node: f, offset: n}
                }

                var c = /\b\w+\b/ig, g, f, h, k, l;
                h = k = l = a.startContainer;
                for (g = e(h); null != (f = c.exec(g));)if (f.index + f[0].length >= a.startOffset)return a = f.index, c = f.index + f[0].length, 0 === f.index && (f = d(h, !0), k = f.node, a = f.offset), c >= g.length && (g = d(h), l = g.node, c = g.offset), {
                    startNode: k,
                    startOffset: a,
                    endNode: l,
                    endOffset: c
            ...
            _filterStyles: function (a) {
                var b = CKEDITOR.tools.isEmpty, e = [], d, c;
            ...
            _determineContext: function (a) {
                function b(b) {
                    var d = new CKEDITOR.dom.walker(a), c;
            ...
            _applyStylesToTextContext: function (a, b, e) {
                ...
                for (g = 0; g < e.length; g++)if (b = e[g], -1 === m(d.excludedElementsFromInlineTransform, b.element)) {
                    if (-1 !== m(d.elementsForInlineTransform, b.element))for (b.element = b._.definition.element = "span", f = 0; f < c.length; f++)b._.definition.attributes[c[f]] && delete b._.definition.attributes[c[f]];
                    b.apply(a)
                }
            },
            _applyStylesToListContext: function (a, b, e) {
                var d, c, g;
                for (g = 0; g < e.length; g++)d = e[g], c = b.createBookmark(), "ol" === d.element || "ul" === d.element ?
            ...
            _applyStylesToTableContext: function (a, b, e) {
                ...
                var c, g;
                for (g = 0; g < e.length; g++)c = e[g], -1 !== m(["table", "tr"], c.element) ? k(b,
                    c.element, function (a) {
                        c.applyToObject(a)
                    }) : -1 !== m(["td", "th"], c.element) ? k(b, {td: 1, th: 1}, function (a) {
                    d(a, c)
                }) : -1 !== m(["thead", "tbody"], c.element) ? k(b, {thead: 1, tbody: 1}, function (a) {
                    d(a, c)
                }) : CKEDITOR.plugins.copyformatting._applyStylesToTextContext(a, b, [c])
            },
            _applyFormat: function (a, b) {
                var e = a.getSelection().getRanges()[0], d = CKEDITOR.plugins.copyformatting, c, g;
                if (!e)return !1;
                if (e.collapsed) {
                    g = a.getSelection().createBookmarks();
                    if (!(c = d._getSelectedWordOffset(e)))return;
                    e = a.createRange();
                    e.setStart(c.startNode,
                        c.startOffset);
            ...
            _putScreenReaderMessage: function (a, b) {
                this._getScreenReaderContainer().setText(a.lang.copyformatting.notification[b])
            },
            _addScreenReaderContainer: function () {
                return this._getScreenReaderContainer() ? this._getScreenReaderContainer() : CKEDITOR.document.getBody().append(CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_screen_reader_only cke_copyformatting_notification"\x3e\x3cdiv aria-live\x3d"polite"\x3e\x3c/div\x3e\x3c/div\x3e')).getChild(0)
            },
        ...
        CKEDITOR.config.copyFormatting_keystrokeCopy = CKEDITOR.CTRL + CKEDITOR.SHIFT +
            67;
                ...
                a.on("uiSpace", function (c) {
                    if (c.data.space == a.config.toolbarLocation) {
                        ...
                        for (var q = a.toolbox.toolbars, f = D(a), m = f.length, l = 0; l < m; l++) {
                            var r, n = 0, w, p = f[l], v = "/" !== p && ("/" === f[l + 1] || l == m - 1), x;
                            ...
                            a.addCommand("toolbarCollapse", {
                                readOnly: 1, exec: function (b) {
                                    var a = b.ui.space("toolbar_collapser"), c = a.getPrevious(),
                                        e = b.ui.space("contents"), d = c.getParent(),
                                        f = parseInt(e.$.style.height, 10), h = d.$.offsetHeight,
                ...
                renderHtml: function (a) {
                    ...
                    if (!this._.panel) {
                        var b = this._.panelDefinition, d = this._.panelDefinition.block,
                            ...
                            e = new CKEDITOR.ui.floatPanel(a, k, b), f = e.addListBlock(this.id, d), c = this;
                        e.onShow = function () {
    ...
    (function () {
        function n(a, c, k, d, q, n, u, w) {
            var x = a.config, r = new CKEDITOR.style(u), f = q.split(";");
            q = [];
            for (var m = {}, g = 0; g < f.length; g++) {
                var l = f[g];
                if (l) {
                    var l = l.split("/"), v = {}, p = f[g] = l[0];
                    v[k] = q[g] = l[1] || p;
                    m[p] = new CKEDITOR.style(u, v);
                    m[p]._.definition.name = p
                } else f.splice(g--, 1)
            }
            a.ui.addRichCombo(c, {
                label: d.label,
                ...
                requiredContent: r,
                contentTransformations: [[{
                    element: "font", check: "span", left: function (b) {
                        return !!b.attributes.size || !!b.attributes.align || !!b.attributes.face
                    }, right: function (b) {
                ...
                panel: {
                    css: [CKEDITOR.skin.getPath("editor")].concat(x.contentsCss),
                    multiSelect: !1,
                ...
                onClick: function (b) {
                    a.focus();
                    a.fire("saveSnapshot");
                    var c = this.getValue(), k = m[b];
                    if (c && b != c) {
                        var d = m[c], e = a.getSelection().getRanges()[0];
                        if (e.collapsed) {
                            var f = a.elementPath(), h = f.contains(function (a) {
                                return d.checkElementRemovable(a)
                            });
                            if (h) {
                                var g = e.checkBoundaryOfElement(h, CKEDITOR.START),
                                    l = e.checkBoundaryOfElement(h, CKEDITOR.END);
                                if (g && l) {
                                    for (g = e.createBookmark(); f = h.getFirst();)f.insertBefore(h);
                                    h.remove();
                                    e.moveToBookmark(g)
                                } else g ? e.moveToPosition(h, CKEDITOR.POSITION_BEFORE_START) : l ? e.moveToPosition(h, CKEDITOR.POSITION_AFTER_END) : (e.splitElement(h), e.moveToPosition(h, CKEDITOR.POSITION_AFTER_END), t(e, f.elements.slice(), h));
                                a.getSelection().selectRanges([e])
                            }
                        } else a.removeStyle(d)
                    }
                    a[c == b ? "removeStyle" : "applyStyle"](k);
                    a.fire("saveSnapshot")
                },
                onRender: function () {
                ...
                refresh: function () {
                    a.activeFilter.check(r) || this.setState(CKEDITOR.TRISTATE_DISABLED)
                }
            })
        }
        ...
        function t(a, c, k) {
            var d = c.pop();
            if (d) {
                if (k)return t(a, c, d.equals(k) ? null : k);
                k = d.clone();
                a.insertNode(k);
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("justify", {
            init: function (a) {
                if (!a.blockless) {
                    var c = new g(a, "justifyleft", "left"), b = new g(a, "justifycenter", "center"),
                        h = new g(a, "justifyright", "right"), d = new g(a, "justifyblock", "justify");
        ...
        CKEDITOR.plugins.add("link", {
            requires: "dialog,fakeobjects", onLoad: function () {
                ...
                c.addMenuItems && c.addMenuItems({
                    ...
                    link: {
                        label: c.lang.link.menu, command: "link",
                        group: "link", order: 1
                    },
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c) {
                ...
                for (var b = c.editable(), a = b.isInline() && !c.plugins.divarea ? c.document : b, b = a.getElementsByTag("a"), a = a.getElementsByTag("img"),
                         f = [], e = 0, d; d = b.getItem(e++);)(d.data("cke-saved-name") || d.hasAttribute("name")) && f.push({
            ...
            parseLinkAttributes: function (c, b) {
                var a = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    f = c.plugins.link.compiledProtectionFunction, e = c.config.emailProtection, d, g = {};
                ...
                if (!g.type)if (e = a.match(x)) g.type = "anchor", g.anchor = {}, g.anchor.name = g.anchor.id = e[1]; else if (e = a.match(u)) {
                    d = a.match(v);
                    a = a.match(w);
                    g.type = "email";
                    var k = g.email = {};
                ...
                l = {
                    target: 1, onclick: 1,
                    "data-cke-pa-onclick": 1, "data-cke-saved-name": 1, download: 1
                };
        ...
        CKEDITOR.unlinkCommand.prototype = {
            exec: function (c) {
                var b = new CKEDITOR.style({
                    element: "a", type: CKEDITOR.STYLE_INLINE,
        ...
        CKEDITOR.removeAnchorCommand.prototype = {
            exec: function (c) {
                ...
                if (b && (f = b.getSelectedElement()) &&
                    (f.getChildCount() ? f.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, f))) f.remove(1); else if (f = CKEDITOR.plugins.link.getSelectedLink(c)) f.hasAttribute("href") ? (f.removeAttributes({
                    name: 1,
        ...
        CKEDITOR.plugins.add("pastefromword", {
            requires: "clipboard", init: function (a) {
                ...
                a.on("paste", function (d) {
                    var c = d.data, h = c.dataValue,
                        g = /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument|<o:\w+>|<\/font>)/,
                        e = {dataValue: h};
                    if (h && (b || g.test(h)) && (!1 !== a.fire("pasteFromWord", e) || b)) {
                        c.dontFilter = !0;
                        var k = l(a, f, function () {
                            if (k) a.fire("paste", c); else if (!a.config.pasteFromWordPromptCleanup || b || confirm(a.lang.pastefromword.confirmCleanup)) e.dataValue = CKEDITOR.cleanWord(e.dataValue, a), a.fire("afterPasteFromWord", e), c.dataValue = e.dataValue;
                            b = 0
                        });
                        k && d.cancel()
                    }
        ...
        CKEDITOR.plugins.add("showblocks", {
            onLoad: function () {
                var a = "p div pre address blockquote h1 h2 h3 h4 h5 h6".split(" "), c, b, e, f,
                    ...
                    9 > CKEDITOR.env.version), g = l ? ":not([contenteditable\x3dfalse]):not(.cke_show_blocks_off)" : "", d,
                    h;
        ...
        addMenuItems: function (a) {
            ...
            a.on("beforeCommandExec", function (b) {
                ...
                "wysiwyg" == a.mode ? d && (c.destroy(a), a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED)) : "bold" !== b.data.name && "italic" !== b.data.name && "underline" !== b.data.name && "strike" !== b.data.name && "subscript" !== b.data.name && "superscript" !== b.data.name && "enter" !== b.data.name && "cut" !== b.data.name && "language" !== b.data.name || !d || ("cut" === b.data.name && (g = !1, f = !0), "language" === b.data.name && (e = (e = a.plugins.language.getCurrentLangElement(a)) && e.$, f = !0), a.fire("reloadMarkupScayt", {
                        removeOptions: {
                            removeInside: g, forceBookmark: f,
                            selectionNode: e
                        }, timeout: 0
                    }))
            });
            ...
            if (a.config.scayt_disableOptionsStorage) {
                var c = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0,
                    ...
                    g = CKEDITOR.tools.search, h = CKEDITOR.tools.indexOf;
            ...
            return {
                scayt: {
                    scayt_ignore: {
                        ...
                        group: "scayt_control", order: 1, exec: function (a) {
                            a.scayt.ignoreWord()
                        }
                    },
                    scayt_ignoreall: {
            ...
            if (0 < c.length && "no_any_suggestions" !== c[0])if (d)for (d = 0; d < c.length; d++) {
                ...
                d < a.config.scayt_maxSuggestions ? (a.addMenuItem(k, {
                    ...
                    label: c[d], command: k, group: "scayt_moresuggest",
                    order: d + 1
                ...
                label: c[d], command: k, group: "grayt_suggest",
                order: d + 1
            ...
            var d = a.scayt, b = this.scaytMenuDefinition(a), e = {}, f = a.config.scayt_contextCommands.split("|"),
                g = c.getAttribute(d.getLangAttribute()) || d.getLang(), h, k;
            h = d.isScaytNode(c);
            k =
                d.isGraytNode(c);
            ...
            this.loadScaytLibrary(a, function (a) {
                ...
                if (f) {
                    ...
                    g.addMarkupHandler && g.addMarkupHandler(function (c) {
                        var d = a.editable(), e = d.getCustomData(c.charName);
        ...
        CKEDITOR.plugins.add("stylescombo", {
            requires: "richcombo", init: function (c) {
                ...
                c.ui.addRichCombo("Styles", {
                    ...
                    onOpen: function () {
                        var b =
                            c.getSelection().getSelectedElement(), b = c.elementPath(b), a = [0, 0, 0, 0];
                        this.showAll();
                        this.unmarkAll();
                        for (var h in f) {
    ...
    (function () {
        ...
        function w(e, d, b) {
            ...
            var g = CKEDITOR.tools.buildTableMap(a), h = g.length, k = g[0].length, l = e.getParent().$.rowIndex,
                n = z(g, l, e);
            if (d) {
                var r;
                try {
            ...
            for (d = 0; d < c.length; d++) {
                f = c[d];
                var m = f.getParent(), x = f.getFirst(), v = f.$.colSpan, y = f.$.rowSpan, m = m.$.rowIndex,
                    A = z(g, m, f), w = w + v * y, q = Math.max(q, A - n + v);
                r = Math.max(r, m - l + y);
        ...
        function A(e, d) {
            ...
            var b = b[0], c = b.getParent(), a = c.getAscendant("table"), f = CKEDITOR.tools.buildTableMap(a),
                g = c.$.rowIndex, h = z(f, g, b), k = b.$.rowSpan, l;
            if (1 < k) {
                l = Math.ceil(k / 2);
        ...
        function B(e, d) {
            ...
            if (d)return !0;
            var b =
                    b[0], c = b.getParent(), a = c.getAscendant("table"), a = CKEDITOR.tools.buildTableMap(a),
                f = z(a, c.$.rowIndex, b), g = b.$.colSpan;
        ...
        CKEDITOR.plugins.tabletools =
            {
                ...
                b("columnDelete", d({
                    requiredContent: "table", exec: function (a) {
                        ...
                        for (r = e; r <= l; r++)for (m = 0; m < d.length; m++)c = d[m], b = new CKEDITOR.dom.element(a.$.rows[m]), c = new CKEDITOR.dom.element(c[r]),
                ...
                e.addMenuItems && e.addMenuItems({
                    ...
                    tablecell_merge_right: {
                        label: c.cell.mergeRight, group: "tablecell",
                        command: "cellMergeRight", order: 17
                    },
                    ...
                    tablerow: {
                        label: c.row.menu, group: "tablerow",
                    ...
                    tablecolumn: {
                        label: c.column.menu, group: "tablecolumn", order: 1,
                        getItems: function () {
                            return {
